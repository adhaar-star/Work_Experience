...
<html>
  ...
  src="https://maps.googleapis.com/maps/api/js?libraries=geometry,places">
    ...
    max-width: 100%;
	 ...
	 html, body, .container-fluid, .row, .map { height: 103.666%;}
...
var Flight2 = new google.maps.Polyline({
   ...
   if(t1<10 && t1>1 &&  DrivePath.length==(t1))
   {
...
function enddetails(k3,t,m1,location2)
   {
     ...
     $.getJSON('http://api.openweathermap.org/data/2.5/forecast/daily?lat='+location2.lat()+'&lon='+location2.lng()+'&cnt=5&mode=json&APPID=f445c5c0ab5fe17b3a86807d237f710c',  function (data) {
					 ...
					 setTimeout(function(){ 
      if(k3==2){
						       $( "#info" ).append("Day"+(k3+2)+" :   "+data.city.name+" <div style=margin-left:300px;><div style=margin-top:-20px;> "+"High"+"          "+Math.round(((data.list[k3-1+2].temp.max-273.15)*9/5)+32)+"    /   "+"Low"+"         "+Math.round(((data.list[k3-1].temp.min-273.15)*9/5)+32)+"</br>");
                      var temp=  Math.round(((data.list[k3-1+2].temp.min-273.15)*9/5)+32);
					 }
					 if(k3==3){
						       $( "#info" ).append("Day"+(k3+2)+" :   "+data.city.name+" <div style=margin-left:300px;><div style=margin-top:-20px;> "+"High"+"          "+Math.round(((data.list[k3-1].temp.max-273.15)*9/5)+32)+"    /   "+"Low"+"         "+Math.round(((data.list[k3-1].temp.min-273.15)*9/5)+32)+"</br>");
                          var temp=  Math.round(((data.list[k3-1+2].temp.min-273.15)*9/5)+32);
					 }
					 if(k3==4){
						       $( "#info" ).append("Day"+(k3+2)+" :   "+data.city.name+" <div style=margin-left:300px;><div style=margin-top:-20px;> "+"High"+"          "+Math.round(((data.list[k3-1].temp.max-273.15)*9/5)+32)+"    /   "+"Low"+"         "+Math.round(((data.list[k3-1].temp.min-273.15)*9/5)+32)+"</br>");
...
if(k==0){
	...
	if(strUser==0){
				...
				for(var j=0;j<2;j++){
					if(j==1){
								$("#info").append("Day"+(k+j)+"                                    "+"&nbsp;"+":"+"&nbsp;"+data.city.name+" <div style=margin-left:300px;><div style=margin-top:-20px;> "+"High"+"              "+Math.round(((data.list[datevalue+j].temp.max-273.15)*9/5)+32)+"    /   "+"Low"+"              "+Math.round(((data.list[datevalue+j].temp.min-273.15)*9/5)+32));
 ...
 $("#info").append('<div style=" width:10px; height:27px; margin-left:-25px; margin-top:-27px; ">'+'<img src="red.png">'+'</div>');
  ...
  $('#warnings').show();
	...
	wcount++;
		...
		$("#info").append("Day"+(k1+strUser3+1)+"                     "+"&nbsp;"+":"+"&nbsp;"+data.city.name+" <div style=margin-left:300px;><div style=margin-top:-20px;> "+"High"+"              "+Math.round(((data.list[k1+strUser3+2].temp.max-273.15)*9/5)+32)+"    /   "+"Low"+"              "+Math.round(((data.list[k1+strUser3+2].temp.min-273.15)*9/5)+32));
			}
			else{
	...
	if(strUser3==1){
		...
		if(k1+strUser3<10){
					...
					$("#info").append("Day"+(k1+strUser3)+"                     "+"&nbsp;"+":"+"&nbsp;"+data.city.name+" <div style=margin-left:300px;><div style=margin-top:-20px;> "+"High"+"              "+Math.round(((data.list[k1+strUser3+2].temp.max-273.15)*9/5)+32)+"    /   "+"Low"+"              "+Math.round(((data.list[k1+strUser3+2].temp.min-273.15)*9/5)+32));
...
$.each(sequence1, function(i, e) {
 ...
 for (var q = 0; q< result1.length; q++)
 {
  ...
  $.getJSON('http://api.openweathermap.org/data/2.5/forecast/daily?lat='+location2.lat()+'&lon='+location2.lng()+'&cnt=16&mode=json&APPID=f445c5c0ab5fe17b3a86807d237f710c',  function (data) {
	      ...
	      $( "#info" ).append("Day"+(t-(-strUser-strUser3-1))+"&nbsp;"+"&nbsp;"+":"+"&nbsp;"+data.city.name+" <div style=margin-left:300px;><div style=margin-top:-20px;> "+"High"+"          "+Math.round(((data.list[t-(-strUser-strUser3-1)].temp.max-273.15)*9/5)+32)+"    /   "+"Low"+"         "+Math.round(((data.list[t-(-strUser-strUser3-1)].temp.min-273.15)*9/5)+32)+"</br>");
	...
	if(strUser3==1){
      ...
      $( "#info" ).append("Day"+(t-(-strUser-strUser3))+"&nbsp;"+"&nbsp;"+":"+"&nbsp;"+data.city.name+" <div style=margin-left:300px;><div style=margin-top:-20px;> "+"High"+"          "+Math.round(((data.list[t-(-strUser-strUser3)].temp.max-273.15)*9/5)+32)+"    /   "+"Low"+"         "+Math.round(((data.list[t-(-strUser-strUser3)].temp.min-273.15)*9/5)+32)+"</br>");
...
var postData='feedback='+feedback;
$.ajax({
...
$.ajax({
	...
	success: function(data,status, xhr)
    {
	   ...
	   if(data=='This Email id alreday exists.Do you want to send the invite again to this id?'){
		  	 var mailcounter=0;
		 var lightbox = document.getElementById("lightbox");
		 		 lightbox.innerHTML="An account with this email id already exists.<br><button type='button' button class='btn btn-large btn-default' style='margin-top:10px;' id='okay'>Okay</button><button type='button' class='btn btn-large btn-default' style='margin-top:10px;margin-left:10px;' id='reinvite'>Re-invite</button><br/><img src='loading.gif' id='loading-indicator1' style='display:none;margin-top: -10px;height: 150;' />";
...
dimmer.style.visibility = 'hidden';
     ...
     $('#reinvite').click(function(){
		 ...
		 $("#reinvite").attr("disabled", "disabled"); 
   ...
   $.ajax({
	...
	success: function(data,status, xhr)
    {
		...
		$("#reinvite").removeAttr("disabled");
		
		$('#loading-indicator1').hide();
	document.getElementById("lightbox2").innerHTML=data+'<br>'+'<button type="button" class="btn btn-large btn-default" style="margin-top:40px;width:100px;" id="ok">Ok</button>';
		   	 var lightbox1 = document.getElementById("lightbox2");
			dimmer.style.visibility = 'hidden';
        dimmer1 = document.createElement("div");
  
    dimmer1.style.width =  window.innerWidth + 'px';
    dimmer1.style.height = window.innerHeight + 'px';
    dimmer1.className = 'dimmer1';
    
    dimmer1.onclick = function(){
        document.body.removeChild(this);   
        lightbox.style.visibility = 'hidden';
    }
        $('#ok').click(function(){
...
dimmer1.style.visibility = 'hidden';
    ...
    document.body.appendChild(dimmer1);
    document.getElementById("sendemail").value="";
	  lightbox.style.visibility = 'hidden';
    lightbox1.style.visibility = 'visible';
    lightbox1.style.top = window.innerHeight/2 - 50 + 'px';
    lightbox1.style.left = window.innerWidth/2 - 100 + 'px';
    return false;
 ...
 error: function (jqXHR, status, errorThrown)
    {
		...
		if (jqXHR.status == 500) {
		 ...
		 lightbox.style.visibility = 'hidden';
		 dimmer.style.visibility = 'hidden';
alert("Email could not be sent.there was an error " + errorThrown);  
		}
    }	
   });
	 }
    ...
    return false;
		...
		document.getElementById("lightbox1").innerHTML=data+'<br>'+'<button type="button" class="btn btn-large btn-default" style="margin-top:40px;width:100px;" id="ok">Ok</button>';
...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-4 col-sm-offset-1" id="siteloader1" style="margin-left:55px;">
	
	
	<a class="navbar-brand" href="#">
                <img src="logo.png" alt="" width="350"height="75" style="margin-left: -70px; margin-top: -28;"> 
            </a><br/><br/>
   ...
   <button type="button" class="btn btn-large btn-default" style="margin-top: -40px;margin-left: -34px;background-color:background-color:#F0F8FF;;"id="clickme2" >Back</button><br/>
   

   </div>
			
 
	  <h4 class="modal-title" style="margin-top: 5px;margin-left: -33;"><i class="icon-paragraph-justify2"></i> Create Customer Account</h4>
        ...
        <form role="form">
            <div class="col-lg-10">
                ...
                <div class="form-group" style="margin-left: -46px;margin-top: 0px;">
                   <div id="lightbox" style='text-align:center;margin-top:-390px;left:134.5%'>An account with this email id already exists.<br>
				      
					   
     <img src="loading.gif" id="loading-indicator1" style="display:none;margin-top: -10px;height: 150;" />
				   </div>
				    <div id="lightbox1" style='text-align:center;margin-top:-390px;left:134.5%;'></div>
					 <div id="lightbox2" style='text-align:center;margin-top:-390px;left:134.5%;'></div>
                   <div class="col-sm-14"><input type="text" class="form-control" id='sendemail' name="email" placeholder="Email Address" required="" style="background-color:background-color:#F0F8FF;;"/><br/>
		          </div>
				
				 
             
      <button class="btn btn-sm btn-danger " type="button" name="submit" id="btn-login" onclick='SendInvite()'>Create Account & Send Invite </button> <br/><br/> <div id="picoutput" style="height:60px;"></div></form>
  ...
  <div class="col-sm-4 col-sm-offset-1" id="siteloader5" style="margin-left:55px;">
   ...
   <button type="button" class="btn btn-large btn-default" id="clickme4" style="margin-top: -40px;margin-left: -34px;;"id="clickme4" >Back</button><br/>
   </div>
		
  <h3 class="modal-title" style="margin-left:-30;"><i class="icon-paragraph-justify2"></i> Recent Online Users</h3>
  <div id='siteloader3'>
  <?php
...
//continue only if $_POST is set and it is a Ajax request
	...
	include("dbconnection.php");  //include config file
	...
	$result2 = mysql_query($sql); //hold total records in variable
	//break records into pages
	 $rec_count = (mysql_num_rows($result2)+1);
	 $item_per_page=10;
	$total_pages = ceil($rec_count/$item_per_page);
	...
	$query = "SELECT email, date, time FROM `login` where id>1 ORDER BY date DESC,time DESC  LIMIT $page_position, $item_per_page";
	$result = mysql_query($query)or die(mysql_error());
	
	
echo	'<table class="table table-striped" style="margin-left:-30;" >
    <thead >
      <tr >
...
echo  "</table>";
	...
	echo paginate_function($item_per_page, $page_number, $rec_count, $total_pages);
	echo '</div>';
...
?>
   ...
   <div class="col-sm-4 col-sm-offset-1" id="siteloader" style="margin-left:55px;"  >
	...
	<a class="navbar-brand" href="#">
     ...
     <div class="form-group" id="locationField" style=" position: absolute; margin-top:10px;" >
...
<button type="button" class="btn btn-large btn-default"id="clickme1" style="margin-bottom:0px;margin-left:-41px; background-color:#F0F8FF;height:32;">Create Customer</button>
   <button type="button" class="btn btn-large btn-default" id="clickme3"style="margin-bottom:0px;background-color:#F0F8FF;height:32;">See recent users</button>
...
?>
      ...
      <img class="img-responsive" src="first-location.png" alt=""style="margin-left:-55px;margin-top:-3px;"/>   <input type="text" id="autocomplete" class="form-control" name="autocomplete" onchange="calcRoute(); " placeholder="Enter Shipping Location" required="" style="height:28;width:300px; margin-top:-39px; margin-left:-20px;background-color:#F0F8FF;"/>
	   
	   

 <img class="img-responsive" src="end-loction.png" alt=""style="margin-left:-55px;margin-top:-3px;"/>  <input type="text" id="autocomplete1" class="form-control" name="autocomplete1" placeholder="Enter Destination"  required="" style="height:28;width:300px;margin-top:-32px; margin-left:-20px; background-color:#F0F8FF;" /></div>
		  
		  </br><br/>
<div id="rail" style="display: list-item;margin-top:158px;margin-left: -220px;">
...
<div id='loaddate'  style='margin-top:-22px;'><img class="img-responsive" src="transittime.png" alt=""style="margin-top:5px;margin-left:385px;"><div id='extra' style='margin-top:-24px;margin-left:201px;'>Load Date      <select id='selectloaddate' onChange="loadFunction();" ><option id='ld1'><?php echo date("m/d/Y"); ?></option><option id='ld2'> <?php $datetime = new DateTime('tomorrow'); echo $datetime->format('m/d/Y'); ?> </option><option id='ld3'><?php $datetime = new \DateTime('tomorrow + 1day'); echo $datetime->format('m/d/Y'); ?></option></select></div></div>
 
<div id='date' margin-left:10px;><img class="img-responsive" src="transittime.png" alt=""style="margin-top:-22px;margin-left:175px;"><div id='extra' style='margin-top:-24px;margin-left:411px;'>Ship Date      <select id='selectdate'   ><option id='sd1'> <?php $datetime = new DateTime('tomorrow'); echo $datetime->format('m/d/Y'); ?> </option><option id='sd2'><?php $datetime = new \DateTime('tomorrow + 1day'); echo $datetime->format('m/d/Y'); ?></option><option id='sd3'><?php $datetime = new \DateTime('tomorrow + 2day'); echo $datetime->format('m/d/Y'); ?></option></select></div></div></div>
...
<div class="col-sm-6" style=" margin-top:-35px; margin-left:140px;">
 <select id="mySelect" class="form-control" style="margin-left:0px;height:30px;">
 ...
 <button class="btn btn-md btn-default " type="submit" name="submit" id="calculate" onclick="setTimeout(initialize1(),3000);" style="margin-top:-30px; margin-left:-46px;background-color:#F0F8FF;">Submit</button> 
  <button class="btn btn-md btn-default " type="submit" name="route" id="save"  onclick="SaveRoute();" style="height:32;margin-top:-30px; margin-left:10px;background-color:#F0F8FF;">Save Route</button> 
  <button class="btn btn-md btn-default " type="submit" name="route1" id="delete"  onclick="DeleteRoute();" style="height:32;display:none;margin-top:-30px; margin-left:10px;background-color:#F0F8FF;">Delete Route</button> 
...
<div id='yellow' style='margin-top:7px;'><img src="yellow.png"style="margin-bottom:0px; margin-left:-35px; margin-top:0px;"/>Warning for beverages with low suger content or glass packaging</div><br/>
