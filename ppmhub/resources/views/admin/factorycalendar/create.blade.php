...
@section('title','Factory Calendar')
    ...
    <div class="panel-body bg-lightcyan">
        <div class="row">
            <div class="col-lg-12">
                ...
                <form id="factorycalendar" method="post" action="<?php
                if (isset($factorycalendar) && $factorycalendar->id) {
                    echo url('admin/factorycalendar/' . $factorycalendar->id);
                } else {
                    echo url('admin/factorycalendar');
                }
                    ...
                    <div class="margin-bottom-50">
                        <div class="margin-bottom-50">
                            ...
                            <ul class="list-unstyled breadcrumb breadcrumb-custom">
                                ...
                                <li>
                                    <a href="{{url('admin/factorycalendar')}}">Factory Calendar</a>
                                </li>
                                <li>
                                    <span>
                                        @if(isset($factorycalendar) && $factorycalendar->id)
                        ...
                        <div class="card">
                            ...
                            <div class="card-block bg-lightcyan">
                                <div class="row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-12 col-sm-2">
                                                <div class="form-input-icon">
                                                    ...
                                                    if (isset($factorycalendar)) {
                                                        echo $factorycalendar->name;
                                                    }
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-12 col-sm-2">
                                                <div class="form-input-icon">
                                                    ...
                                                    if (isset($factorycalendar)) {
                                                        echo $factorycalendar->description;
                                                    }
                                                    ?>" required="required" class="form-control border-radius-0">
                                                </div>
                                            </div>
                                    ...
                                    <?php
                                    if (isset($factorycalendar->created_at) && (!empty($factorycalendar->created_at))) {
                                            ...
                                            <div class="col-xs-12 col-sm-2">
                                                <div class="btn-group" data-toggle="buttons">
                                                    <a class="active-bttn btn btn-primary active">
                                                        ...
                                                        if (isset($factorycalendar) && $factorycalendar->status == 'active') {
                                                            echo "checked";
                                                        }
                                                        ?>>
                                                        Active
                                                    ...
                                                    <a class="inactive-btn btn btn-default">
                                                        ...
                                                        if (isset($factorycalendar) && $factorycalendar->status == 'inactive') {
                                                            echo "checked";
                                                        }
                                                        ?>>
                                                        Inactive
                            ...
                            <div class="card-footer card-footer-box">
                                ...
                                <a href="{{url('admin/factorycalendar')}}"><button type="button" class="btn btn-danger">Cancel</button></a>
                            </div>                       
