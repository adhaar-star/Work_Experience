    ...
    <div class="panel-body bg-lightcyan">
        <div class="row">
            <div class="col-lg-12">
                ...
                <form id="costcentretype" method="post" action="<?php
                if (isset($costcentretype) && $costcentretype->id) {
                    echo url('admin/costcentretype/' . $costcentretype->id);
                } else {
                    echo url('admin/costcentretype');
                }
                    ...
                    <div class="margin-bottom-50">
                        <div class="margin-bottom-50">
                            ...
                            <ul class="list-unstyled breadcrumb breadcrumb-custom">
                                ...
                                <li>
                                    <a href="{{url('admin/costcentretype')}}">Cost Center</a>
                                </li>
                                <li>
                                    <span>
                                        @if(isset($costcentretype) && $costcentretype->id)
                        ...
                        <div class="card">
                            ...
                            <div class="card-block bg-lightcyan">
                                <div class="row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-12 col-sm-2">
                                                <div class="form-input-icon">
                                                    ...
                                                    if (isset($costcentretype)) {
                                                        echo $costcentretype->name;
                                                    }
                                    ...
                                    <?php
                                    if (isset($costcentretype->created_at) && (!empty($costcentretype->created_at))) {
                                            ...
                                            <div class="col-xs-12 col-sm-2">
                                                <div class="btn-group" data-toggle="buttons">
                                                    <a class="active-bttn btn btn-primary active">
                                                        ...
                                                        if (isset($costcentretype) && $costcentretype->status == 'active') {
                                                            echo "checked";
                                                        }
                                                        ?>>
                                                        Active
                                                    ...
                                                    <a class="inactive-btn btn btn-danger">
                                                        ...
                                                        if (isset($costcentretype) && $costcentretype->status == 'inactive') {
                                                            echo "checked";
                                                        }
                                                        ?>>
                                                        Inactive
                                    ...
                                    <div class="card-footer card-footer-box">
                                        ...
                                        <a href="{{url('admin/costcentretype')}}"><button type="button" class="btn btn-danger">Cancel</button></a>
                                    </div>                       
