    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-lg-12">
                ...
                {!! Form::open([ 'route' => ['qualitativeRisk.update', $qualitative_data->id],'method' => 'put','id' => 'qualitativeContextform']) !!}
                {{ csrf_field() }}
                <div class="margin-bottom-50">
                    <div class="margin-bottom-50">
                        <ul class="list-unstyled breadcrumb breadcrumb-custom">
                            ...
                            <li>
                                <span>Edit Qualitative Risk Context</span>
                            </li>
                        </ul>
                    </div>
                    @if (count($errors) > 0)
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                            <div class="form-input-icon">
                                                {!!Form::text('risk_type',isset($qualitative_data->risk_type) ? $qualitative_data->risk_type : '',array('class'=>'form-control header_note  border-radius-0 no-resize','readonly'))!!}                                    
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-10 col-lg-9">
                                            {!!Form::textarea('strategic_context',isset($qualitative_data->strategic_context) ? $qualitative_data->strategic_context : '',array('class'=>'form-control border-radius-0 texteditorSet','rows' => 7, 'cols' => 10,'maxlength'=>300))!!}                                    
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-10 col-lg-9">
                                            {!!Form::textarea('organisational_context',isset($qualitative_data->organisational_context) ? $qualitative_data->organisational_context : '',array('class'=>'form-control border-radius-0 texteditorSet','rows' => 7, 'cols' => 10,'maxlength'=>300))!!}                                    
                                            <p class="counterText text-center redset">Maximum 300 Characters Only</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-10 col-lg-9">
                                            {!!Form::textarea('riskmanagement_context',isset($qualitative_data->riskmanagement_context) ? $qualitative_data->riskmanagement_context : '',array('class'=>'form-control border-radius-0 texteditorSet','rows' => 7, 'cols' => 10,'maxlength'=>300))!!}                                    
                                            <p class="counterText text-center redset">Maximum 300 Characters Only</p>
                                        </div>
                                    </div>
                                </div>
