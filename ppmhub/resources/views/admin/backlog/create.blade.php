...
@section('title','Create Backlog | Agile Methodology')
@section('body')
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                ?>
                    ...
                    <form id="Projectphaseform" method="post" action="{{url('admin/backlog/create')}}" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                  {{ csrf_field() }}
                                        <div class="margin-bottom-50">
                      ...
                      <select id="sprint_no" name="sprint_no"  class="form-control col-md-7 col-xs-12 select2">
                          ...
                          @foreach($sprint_number as $sprint_number_list)
                            ...
                            <option value="{{$sprint_number_list->id}}">{{$sprint_number_list->id}} ({{$sprint_number_list->sprint_number}})</option>
                          @endforeach
                          ...
                          @foreach($component as $component_list)
                            ...
                            <option value="{{$component_list->id}}">{{$component_list->component_name}}</option>
                          @endforeach
                          ...
                          @foreach($projectIssue as $projectIssue_list)
                            ...
                            <option value="{{$projectIssue_list->id}}">{{$projectIssue_list->title}} {{$projectIssue_list->description}}</option>
                          @endforeach
