        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="dashboard-buttons">
                    @if (RoleAuthHelper::hasAccess('departmentType.create')!=true)  
                    <a href="javascript:void(0)" class="btn btn-default" style="cursor:no-drop; color:#97A7A7;">
                        @else
                        <a href="{{url('admin/departmenttype/create')}}" class="btn btn-primary">
                            @endif
                ...
                <div class="col-md-12">
                    <div class="margin-bottom-50">
                        <table class="table table-inverse" id="example3" width="100%">
                            ...
                            <tbody>
                                @foreach($departmenttype as $ptype)
                                <tr>
                                    <td>{{$ptype->name }}</td>
                                    <td>
                                    ...
                                    <td class="action-btn">
                                        @if (RoleAuthHelper::hasAccess('departmentType.view')!=true)  
                                        <a href="javascript:void(0)" class="btn btn-default btn-xs margin-right-1" style="cursor:no-drop; color:#97A7A7;">
                                            @else
                                            <a href="#" class="btn btn-info btn-xs margin-right-1" data-toggle="modal" data-target="#table-view-popup_{{$ptype->id }}">@endif<i class="fa fa-eye" aria-hidden="true"></i> <!--view--> </a>
                                            @if (RoleAuthHelper::hasAccess('departmentType.update')!=true)  
                                            <a href="javascript:void(0)" class="btn btn-default btn-xs margin-right-1" style="cursor:no-drop; color:#97A7A7;">
                                                @else
                                                <a href="{{url('admin/departmenttype/'.$ptype->id.'/edit')}}" class="btn btn-info btn-xs margin-right-1">@endif<i class="fa fa-pencil"></i>  </a>

                                                {!! Form::open(array('route' => array('departmentType.delete',$ptype->id), 'method' => 'DELETE','id'=>'delform'.$ptype->id)) !!}
                                                @if (RoleAuthHelper::hasAccess('departmentType.delete')!=true)  
                                                <a href="javascript:void(0)" class="btn btn-default btn-xs margin-right-1" style="cursor:no-drop; color:#97A7A7;">
                                                    @else
                                                    <a href="javascript:void(0)" onclick="var res = confirm('Are you sure you want to delete this department');
                                                              if (res) {
                                                        ...
                                                        <div class="modal-dialog" role="document" style="text-align:left;">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form class="static-form">
                                                                        ...
                                                                        <div class="form-group popup-brd-btm">
                                                                            ...
                                                                            <div class="col-sm-5">
                                                                                <p class="form-control-static">{{$ptype->description}}</p>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group popup-brd-btm">
                                                                            <div class="col-sm-5">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <span class="edit-btn"><a href="{{url('admin/departmenttype/'.$ptype->id.'/edit')}}" class="btn btn-primary">Edit</a></span>
