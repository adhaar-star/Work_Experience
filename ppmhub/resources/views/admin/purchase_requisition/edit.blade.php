                                    ...
                                    <div class="tab-pane active" id="purchase-desc" role="tabpanel">
                                        ...
                                        <div class="tab-block">
                                            <div class="form-group row">
                                                {!!Form::textarea('header_note',isset($purchase_requisition->header_note) ? $purchase_requisition->header_note : '',array('class'=>'form-control border-radius-0 no-resize','placeholder'=>'Please enter Header note','maxlength'=>255))!!}
                                            </div>
                            ...
                            <tbody id='purchase_item_form'>
                                ...
                                <tr id='purchase_item_0' class = "form">
                                    <td class="text-center line-height-2">
                                        <div class="radio">
                                            <label><input type="radio" name="optradio" value='#purchase_item_0' id='0   ' checked=""/></label>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        {!!Form::text('item_no',isset($purchase_item->item_no) ? $purchase_item->item_no : 10,array('class'=>'form-control border-radius-0 padding-input'))!!}

                                    </td>
                                    <td>
                                        {!!Form::select('item_category',['Material'=>'Material','Service'=>'Service','Asset'=>'Asset'],isset($purchase_item->item_category)? $purchase_item->item_category:'',array('class'=>'form-control select2','placeholder'=>'Please select Item Category'))!!}
                                    </td>
                                    <td>
                                        {!!Form::select('material',$material,isset($purchase_item->material)? $purchase_item->material:'',array('class'=>'form-control select2','placeholder'=>'Please select Material'))!!}
                                    </td>
                                    <td>
                                        {!!Form::textarea('material_description',isset($purchase_item->material_description) ? $purchase_item->material_description : '',array('class'=>'form-control padding-input border-radius-0 no-resize resize-textarea','placeholder'=>'Enter Description'))!!}
                                    </td>
                                    <td>
                                        {!!Form::number('item_quantity',isset($purchase_item->item_quantity) ? $purchase_item->quantity : '',array('class'=>'form-control padding-input border-radius-0','placeholder'=>'Please enter Quantity','min'=>0))!!}
                                    </td>
                                    <td>
                                        {!!Form::select('quantity_unit',['Liters'=>'Liters','Metric Ton'=>'Metric Ton','Pieces'=>'Pieces'],isset($purchase_item->quantity_unit)? $purchase_item->quantity_unit:'',array('class'=>'form-control select2','placeholder'=>'Please select Quantity Unit'))!!}
                                    </td>
                                    <td>
                                        {!!Form::number('item_cost',isset($purchase_item->item_cost) ? $purchase_item->item_cost : '',array('class'=>'form-control padding-input border-radius-0','placeholder'=>'Please enter Item Cost','min'=>0))!!}
                                    </td>
                                    <td>
                                        {!!Form::select('currency',$currency,isset($purchase_item->currency) ? $purchase_item->currency : '',array('class'=>'form-control select2','placeholder'=>'Please enter Item Cost Unit'))!!}
                                    </td>
                                    <td>
                                        {!!Form::text('delivery_date',isset($purchase_item->delivery_date) ? $purchase_item->delivery_date : '',array('class'=>'form-control border-radius-0 datepicker-only-init','placeholder'=>'Please enter Delivery Date'))!!}
                                    </td>
                                    <td>
                                        {!!Form::select('material_group',['Raw Material'=>'Raw Material','Service Material'=>'Service Material'],isset($purchase_item->material_group)? $purchase_item->material_group:'',array('class'=>'form-control select2','placeholder'=>'Please select Material Group'))!!}
                                    </td>
                                    <td>     
                                        {!!Form::select('vendor',$vendor,isset($purchase_item->vendor)? $purchase_item->vendor:'',array('class'=>'form-control select2','placeholder'=>'Please select Vendor'))!!}
                                    </td>
                                    <td>
                                        {!!Form::select('requestor',$requestedby,isset($purchase_item->requestor) ? $purchase_item->requestor : '',array('class'=>'form-control select2 border-radius-0','placeholder'=>'Please enter Requestor id'))!!}
                                    </td>
                                    <td>
                                        {!!Form::select('contract_number',['1'=>'1','2'=>'2','3'=>'3'],isset($purchase_item->contract_number)? $purchase_item->contract_number:'',array('class'=>'form-control select2','placeholder'=>'Please select Contract Number','min'=>0))!!}
                                    </td>
                                    <td>
                                        {!!Form::select('contract_item_number',['1'=>'1','2'=>'2','3'=>'3'],isset($purchase_item->contract_item_number)? $purchase_item->contract_item_number:'',array('class'=>'form-control select2','placeholder'=>'Please select Contract Item Number','min'=>0))!!}
                                    </td>
                                ...
                                <tr id="purchase_item_{{$loop->index}}" class = "form">
                                    <td class="text-center line-height-2">
                                        <div class="radio">
                                            <label><input type="radio" name="optradio" class='special-radio' id='{{$loop->index}}' value='#purchase_item_{{$loop->index}}' @php if($loop->first)echo 'checked'; @endphp /></label>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        {!! Form::open(array('route' => array('purchase_requisition.item.delete',$purchase_item->id), 'method' => 'DELETE','id'=>'delform'.$purchase_item->id)) !!}
                                        <a href="javascript:void(0)" onclick="{var res = confirm('Are you sure you want to delete this purchase item');
                                    ...
                                    <td>
                                        {!!Form::number('item_quantity',isset($purchase_item->item_quantity) ? $purchase_item->item_quantity : '',array('class'=>'form-control border-radius-0 padding-input','onchange'=>'{getTotal(event);}','placeholder'=>'Please enter Quantity'))!!}
                                    </td>
                                    <td>
                                        {!!Form::select('quantity_unit',['Liters'=>'Liters','Metric Ton'=>'Metric Ton','Pieces'=>'Pieces'],isset($purchase_item->quantity_unit)? $purchase_item->quantity_unit:'',array('class'=>'form-control select2','placeholder'=>'Please select Quantity Unit'))!!}
                                    </td>
                                    <td>
                                        {!!Form::number('item_cost',isset($purchase_item->item_cost) ? $purchase_item->item_cost : '',array('class'=>'form-control border-radius-0 padding-input','placeholder'=>'Please enter Item Cost','min'=>0,'onchange'=>'{getTotal(event);}','onkeypress'=>'return isNumber(event)'))!!}
                                    </td>
                                    <td>
                                        {!!Form::select('currency',$currency,isset($purchase_item->currency) ? $purchase_item->currency : '',array('class'=>'form-control border-radius-0 padding-input select2','placeholder'=>'Please enter Item Cost'))!!}
                                    </td>
                                    <td>
                                        {!!Form::text('delivery_date',isset($purchase_item->delivery_date) ? $purchase_item->delivery_date : '',array('class'=>'form-control border-radius-0 padding-input width-110 datepicker-only-init','placeholder'=>'Please enter Delivery Date'))!!}
                                    </td>
                                    <td>
                                        {!!Form::select('material_group',['Raw Material'=>'Raw Material','Service Material'=>'Service Material'],isset($purchase_item->material_group)? $purchase_item->material_group:'',array('class'=>'form-control select2','placeholder'=>'Please select Material Group'))!!}
                                    </td>
                                    <td>     
                                        {!!Form::select('vendor',$vendor,isset($purchase_item->vendor)? $purchase_item->vendor:'',array('class'=>'form-control select2','placeholder'=>'Please select Quantity Unit'))!!}
                                    </td>
                                    <td>
                                        {!!Form::select('requestor',$requestedby,isset($purchase_item->requestor) ? $purchase_item->requestor : '',array('class'=>'form-control select2 border-radius-0','placeholder'=>'Please enter Requestor id'))!!}
                                    </td>
                                    ...
                                    {!!Form::hidden('project_id',$purchase_item->project_id)!!}
                            ...
                            <table class="table table-list table-responsive margin-top-15">
                                ...
                                <tbody>
                                    <tr id='purchase_hidden_row' class = "form">
                                        ...
                                        <td>
                                            {!!Form::text('item_no',rand(100,9999),array('class'=>'form-control padding-input border-radius-0'))!!}

                                        </td>
                                        <td>
                                            {!!Form::select('item_category',['Material'=>'Material','Service'=>'Service','Asset'=>'Asset'],'',array('class'=>'form-control padding-input','placeholder'=>'Please select Item Category'))!!}
                                        </td>
                                        <td>
                                            {!!Form::select('material',$material,'',array('class'=>'form-control padding-input','placeholder'=>'Please select Material'))!!}
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            {!!Form::number('item_quantity','',array('class'=>'form-control padding-input border-radius-0','placeholder'=>'Please enter Quantity','min'=>0,'onchange'=>'{getTotal(event);}'))!!}
                                        </td>
                                        <td>
                                            {!!Form::select('quantity_unit',['Liters'=>'Liters','Metric Ton'=>'Metric Ton','Pieces'=>'Pieces'],'',array('class'=>'form-control padding-input','placeholder'=>'Please select Quantity Unit'))!!}
                                        </td>
                                        <td>
                                            {!!Form::text('item_cost','',array('class'=>'form-control padding-input border-radius-0','min'=>0,'onchange'=>'{getTotal(event);}','onkeypress'=>'return isNumber(event)'))!!}
                                        </td>
                                        <td>
                                            {!!Form::select('currency',$currency,'',array('class'=>'form-control border-radius-0 padding-input','placeholder'=>'Please enter Item Cost Unit'))!!}
                                        </td>
                                        <td>
                                            {!!Form::text('delivery_date','',array('class'=>'form-control datepicker-only-init border-radius-0 padding-input width-110'))!!}
                                        </td>
                                        <td>
                                            {!!Form::select('material_group',['Raw Material'=>'Raw Material','Service Material'=>'Service Material'],'',array('class'=>'form-control border-radius-0 padding-input','placeholder'=>'Please select Material Group'))!!}
                                        </td>
                                        <td>     
                                            {!!Form::select('vendor',$vendor,'',array('class'=>'form-control padding-input border-radius-0','placeholder'=>'Please select Vendor'))!!}
                                        </td>
                                        <td>
                                            {!!Form::select('requestor',$requestedby,'',array('class'=>'form-control padding-input border-radius-0','placeholder'=>'Please enter Requestor id'))!!}
                                        </td>
                                        <td>
                                            {!!Form::select('contract_number',['1'=>'1','2'=>'2','3'=>'3'],'',array('class'=>'form-control padding-input border-radius-0','placeholder'=>'Please select Contract Number','min'=>0))!!}
                                        </td>
                                        <td>
                                            {!!Form::select('contract_item_number',['1'=>'1','2'=>'2','3'=>'3'],'',array('class'=>'form-control padding-input border-radius-0','placeholder'=>'Please select Contract Item Number','min'=>0))!!}
                                        </td>
                                        {!!Form::hidden('project_id')!!}
                                        {!!Form::hidden('phase_id')!!}
                                        {!!Form::hidden('g_l_account')!!}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            {!!Form::select('phase_id',$phase_ids,isset($purchase_requisition->phase_id)?$purchase_requisition->phase_id:'',array('class'=>'form-control select2','placeholder'=>'Please select Phase Id','id'=>'phase'))!!}
                                                        </div>
                                                        <label class="col-sm-3 control-label">G/L Account:</label>
                                                        <div class="col-sm-3">
                                                            {!!Form::select('g_l_account',$g_l_account,isset($purchase_requisition->g_l_account)?$purchase_requisition->g_l_account:'',array('class'=>'form-control select2','placeholder'=>'Please select G/L account'))!!}
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 control-label">Task ID:</label>
                                                        <div class="col-sm-3">
                                                            {!!Form::select('task_id',$task_ids,isset($purchase_requisition->task_id)?$purchase_requisition->task_id:'',array('class'=>'form-control select2','placeholder'=>'Please select Task Id','id'=>'task'))!!}
                                                        </div>
                                                        <label class="col-sm-3 control-label">Cost Center:</label>
                                                        <div class="col-sm-3">
                                                            {!!Form::select('cost_center',$cost_center,isset($purchase_requisition->cost_center)?$purchase_requisition->cost_center:'',array('class'=>'form-control select2','placeholder'=>'Please select Cost Center'))!!}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane active" id="approval" role="tabpanel">
                                        <div class="padding-left-30 padding-right-30">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    {!!Form::select('approver_1',$requestedby,isset($purchase_requisition->approver_1)? $purchase_requisition->approver_1:'',array('class'=>'form-control select2','placeholder'=>'Please select Approver 1'))!!}
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    {!!Form::select('approver_2',$requestedby,isset($purchase_requisition->approver_2)? $purchase_requisition->approver_2:'',array('class'=>'form-control select2','placeholder'=>'Please select Approver 2'))!!}
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    {!!Form::select('approver_3',$requestedby,isset($purchase_requisition->approver_3)? $purchase_requisition->approver_3:'',array('class'=>'form-control select2','placeholder'=>'Please select Approver 3'))!!}
                                                </div>
                                                <span class="col-sm-4 padding-top-10"></span>
                                            ...
                                            <div class="form-group row padding-bottom-20">
                                                ...
                                                <div class="col-sm-5">
                                                    {!!Form::select('approver_4',$requestedby,isset($purchase_requisition->approver_4)? $purchase_requisition->approver_4:'',array('class'=>'form-control select2','placeholder'=>'Please select Approver 4'))!!}
                                                </div>
                                                <span class="col-sm-4 padding-top-10"></span>
...
<script type="text/javascript">
                                                            ...
                                                            $('#Purchase_requisition_two [name^=' + this.name + ']').val(this.value);
                                                                    ...
                                                                    console.log(obj);
                                                                            ...
                                                                            $.ajax({
                                                                            url: "{{url('/admin/purchase_requisition/update')}}",
                                                                                    method: "POST",
