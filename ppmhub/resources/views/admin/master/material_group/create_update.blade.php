        ...
        <div class="row">
            <div class="col-lg-12">
                @if(!empty($materialGroup))
                    {!! Form::open([ 'route' => [ $route.'.update', $materialGroup->material_group_id ],  'method' => 'put', 'class' => 'form-horizontal GlobalFormValidation' ]) !!}
                @else
                    ...
                    <div class="row PageTitleGlobal">
                        ...
                        <div class="col-md-6 text-right">
                            ...
                            <ul class="list-unstyled breadcrumb breadcrumb-custom">
                                ...
                                <li><a href="{{ route( $route .'.index') }}">Material Groups</a></li>
                                <li><span>@if(!empty($materialGroup))  Update @else Create @endif  Material Group</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header card-header-box bg-lightcyan">
                            @if(empty($materialGroup) )
                                <h4 class="margin-0">Create Material Group</h4>
                            @else
                                <h4 class="margin-0">Update Material Group</h4>
                            @endif
                        </div>
                             ...
                             <div class="row" style="margin: 0;">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-md-4 col-form-label text-right">Group Name<span>*</span>:</label>
                                        <div class="col-xs-12 col-sm-2 col-md-8 col-lg-7">
                                            <div class="form-input-icon">
                                                {!!Form::text('name', !empty($materialGroup) ? $materialGroup->name : null, [
