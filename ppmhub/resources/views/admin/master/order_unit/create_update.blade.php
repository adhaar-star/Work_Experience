...
<section id="create_form" class="panel">
    <div class="panel-body">
        <div class="row">
            <div class="col-lg-12">
                @if(!empty($orderUnit))
                    {!! Form::open([ 'route' => [ $route.'.update', $orderUnit->order_unit_id ],  'method' => 'put', 'class' => 'form-horizontal GlobalFormValidation' ]) !!}
                @else
                    ...
                    <div class="row PageTitleGlobal">
                        ...
                        <div class="col-md-6 text-right">
                            ...
                            <ul class="list-unstyled breadcrumb breadcrumb-custom">
                                ...
                                <li><a href="{{ route( $route .'.index') }}">Order Units</a></li>
                                <li><span>@if(!empty($orderUnit))  Update @else Create @endif Order Unit</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header card-header-box bg-lightcyan">
                            @if(empty($orderUnit) )
                                <h4 class="margin-0">Create Order Unit</h4>
                            @else
                                <h4 class="margin-0">Update Order Unit</h4>
                            @endif
                        </div>
                             ...
                             <div class="row" style="margin: 0;">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-md-4 col-form-label text-right">Order Unit<span>*</span>:</label>
                                        <div class="col-xs-12 col-sm-2 col-md-8 col-lg-7">
                                            <div class="form-input-icon">
                                                {!!Form::text('name', !empty($orderUnit) ? $orderUnit->name : null, [
