...
@section('title','Settings | Customer Number Range')
@section('body')
@if (count($errors) > 0)
            ...
            <div class="col-lg-12">
                ...
                <div class="margin-bottom-50">
                    ...
                    <ul class="list-unstyled breadcrumb breadcrumb-custom">
                        ...
                        <li>
                            <a href="/admin/customer_number_range"> Customer Number Range </a>
                        </li>
                        <li>
                            <span>Edit Customer Number Range</span>
                        </li>
                    </ul>
                </div>
                <h4>Edit Customer Number Range</h4>
                <div class="row">
                    <div class="col-md-12">
                        <div class="margin-bottom-50 margin-top-25">
                            <table class="tableizer-table table table-bordered text-center" border="1" style="width: 60%;">
                                <thead>
                                    <tr style="box-shadow: 0px 0px 0px 0px #eceeef;">
                                ...
                                <tbody> 
                                    {!! Form::open(array('route'=>array('customerNumber.update',$number_range->id),'method' => 'put','id'=>'inquirynumber')) !!}
                                    <tr id="editInquiry_{{$number_range->id}}" class="range">
                                        <td class="startrange">
                                            {!!Form::text('start_range',$number_range->start_range,array('class'=>'form-control border-radius-0 startrange','id'=>'startrange'))!!}
                                        </td>
                                        <td class="endrange">
                                            {!!Form::text('end_range',$number_range->end_range,array('class'=>'form-control border-radius-0 endrange','id'=>'endrange'))!!}
                                        </td>
                                        <td> 
