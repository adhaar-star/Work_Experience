    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive">
                ...
                <tbody>
                    @foreach($projectmilestone as $projchecklist)
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <a href="{{url('admin/projectchecklist/'.$projchecklist->id.'/edit')}}" class="btn btn-info btn-xs margin-right-1"><i class="fa fa-pencil"></i> Edit </a>
                            <form action="{{url('admin/projectchecklist/'.$projchecklist->id)}}" method="post" id="delform">
                                {{ method_field('DELETE') }}
                                {{ csrf_field() }}
                                <a href="javascript:void(0)" onclick="var res = confirm('Are you sure you want to delete this project checklist'); if (res) {
