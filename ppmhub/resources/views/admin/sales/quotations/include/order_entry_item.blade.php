{!! Form::open(['url' =>route('sales-order-quotation-save-item', $order->sales_quotation_id),   'class' => 'form-horizontal  GlobalFormValidation SO_ManageItems']) !!}
@if(!empty($updateItem))
    {!! Form::hidden('sales_quotation_item_id', $updateItem->sales_quotation_item_id ) !!}
@endif
<div class="row">
    <div class="col-sm-6">
       <div class="form-group row">
            <label class="col-xs-12 col-sm-6 col-md-4 col-form-label">Select Material<span>*</span>:</label>
            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                <div class="form-input-icon">
                    {!! Form::select( 'material', $materials,  (!empty($updateItem)) ? $updateItem->material : null,
                     [
                        'class'=>'form-control border-radius-0 select2 SoMaterialOnChange',
                        'data-url'=>route('get-material-by-id'),
                        'placeholder'=>'Select Material',
                        'data-fv-notempty' => true,
                        'data-fv-blank' => true,
                        'data-rule-required' => true,
                        'data-fv-notempty-message' => 'Material is required',
                    ]
                    )!!}
                </div>
            </div>
       ...
       <div class="form-group row">
            <label class="col-xs-12 col-sm-6 col-md-4 col-form-label">Order Quantity<span>*</span>:</label>
            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                <div class="form-input-icon">
                    {!!Form::number('material_quantity', (!empty($updateItem)) ? $updateItem->material_quantity : null, [ 'class'=>'form-control  border-radius-0 no-resize SO_Quantity SO_item', 'placeholder' => 'Please enter Quantity',  'min' => 1, 'max' =>  1000,
       ...
       <div class="form-group row">
            <label class="col-xs-12 col-sm-6 col-md-4 col-form-label">Cost per unit<span>*</span>:</label>
            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                <div class="form-input-icon input-group mb-2 mb-sm-0">
                    {!!Form::number('unit_price', (!empty($updateItem)) ? $updateItem->unit_price : null, ['class'=>'form-control  border-radius-0 no-resize SO_item SO_UnitPrice SO_UnitPriceOnChangeMaterial ',
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                <div class="form-input-icon input-group mb-2 mb-sm-0">
                    {!!Form::number('freight_charges', (!empty($updateItem)) ? $updateItem->freight_charges : null, ['class'=>'form-control  border-radius-0 no-resize  SO_item SO_Freight','placeholder'=>'Enter Freight Charges',  'min' => 0 ] )!!}
                    <div class="input-group-addon"><i class="fa fa-dollar"></i></div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-10 col-lg-offset-1">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td  class="SO_AmountStyle"><span  class="SO_FreightAmount">{{   (!empty($updateItem)) ? $updateItem->freight_charges : 0 }}</span>$</td>
                    </tr>
                    <tr>
                        <td>Tax</td>
...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                <div class="form-input-icon">
                    {!!Form::select('project_id', !empty($projects) ? $projects : [], (!empty($updateItem)) ? $updateItem->project_id : null, [ 'class'=>'form-control  border-radius-0 no-resize SoProjectOnChange select2', 'placeholder' => 'Select Project',
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                <div class="form-input-icon">
                    {!!Form::select('phase_id',  $updatePhases, (!empty($updateItem)) ? $updateItem->phase_id : null,
...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        @endif
        <a href="{{ route('sales-order-quotation-items', $order->sales_quotation_id) }}" class="btn btn-danger">Cancel</a>
    </div>
</div>
{!! Form::close() !!}