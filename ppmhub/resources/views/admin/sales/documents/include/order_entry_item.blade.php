{!! Form::open(['url' =>route('sales-order-document-save-items', $order->sales_document_id),   'class' => 'form-horizontal  GlobalFormValidation SO_ManageItems']) !!}
@if(!empty($updateItem))
...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        @endif
        <a href="{{ route('sales-order-document-items', $order->sales_document_id) }}" class="btn btn-danger">Cancel</a>
    </div>
</div>
{!! Form::close() !!}