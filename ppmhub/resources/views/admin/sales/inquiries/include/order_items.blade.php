<table class="table table-striped">
    ...
    <tbody>
        @forelse($orderItems as $item)
            <tr>
                <td>{{ $item->sales_inquiry_item_no }}</td>
                ...
                <td>
                    <button class="btn btn-info btn-xs margin-right-1" data-toggle="modal" data-target="#table-view-popup_{{ $item->sales_inquiry_item_id }}"><i class="fa fa-eye" aria-hidden="true"></i></button>
                    @if($order->status == 'created')
                        <a href="{{ route('sales-order-inquiry-items', $item->sales_inquiry_id) }}?update_item={{ $item->sales_inquiry_item_id }}" class="btn btn-primary btn-xs margin-right-1"><i class="fa fa-pencil"></i></a>
                        <button  class="btn btn-danger btn-xs margin-right-1 deleteGlobalBtn" data-url="{{ route('sales-order-inquiry-items-delete', $item->sales_inquiry_item_id ) }}"  ><i class="fa fa-trash-o"></i></button>
                    @endif
                    <div class="modal fade table-view-popup" id="table-view-popup_{{ $item->sales_inquiry_item_id }}" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                        <div class="modal-dialog" role="document" style="text-align:left;">
                            <div class="modal-content" style="border-radius: 0;">
                                <div class="modal-header">
                                    <h3 class="model-list-striped-title">Inquiry Item</h3>
                                ...
                                <div class="modal-body model-list-striped">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <p class="form-control-static">{{ $item->sales_inquiry_item_no }}</p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="modal-footer">
                                    @if($order->sales_order_status == 'created' )
                                        <span class="edit-btn"><a href="{{ route('sales-order-inquiry-items', $item->sales_inquiry_id) }}?update_item={{ $item->sales_inquiry_item_id }}" class="btn btn-primary">Edit Item</a></span>
