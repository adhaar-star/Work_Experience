{!! Form::open(['url' =>route('sales-order-save-items', $order->sales_order_id),   'class' => 'form-horizontal  GlobalFormValidation SO_ManageItems']) !!}
@if(!empty($updateItem))
    {!! Form::hidden('sales_order_item_id', $updateItem->sales_order_item_id) !!}
@endif
<div class="row">
    <div class="col-sm-6">
...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        @endif
        <a href="{{ route('sales-order-items', $order->sales_order_id) }}" class="btn btn-danger">Cancel</a>
    </div>
</div>
{!! Form::close() !!}