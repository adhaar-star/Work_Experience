        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                if (isset($capacityunits) && $capacityunits->id) {
                    echo url('admin/capacityunits/' . $capacityunits->id);
                } else {
                    echo url('admin/capacityunits');
                }
                    ...
                    <div class="margin-bottom-50">
                        <div class="margin-bottom-50">
                            ...
                            <ul class="list-unstyled breadcrumb breadcrumb-custom">
                                ...
                                <li>
                                    <a href="{{url('admin/capacityunits')}}">Capacity Units</a>
                                </li>
                                <li>
                                    <span>
                                        @if(isset($capacityunits) && $capacityunits->id)
                ...
                if (isset($capacityunits)) {
                    echo $capacityunits->name;
                }
                ...
                if (isset($capacityunits)) {
                    echo $capacityunits->description;
                }
                ?>" required="required" class="form-control border-radius-0">
                                            </div>
                                        </div>
...
<?php
if (isset($portfolio->created_at) && (!empty($portfolio->created_at))) {
...
<?php } ?>
                                        ...
                                        <div class="col-xs-12 col-sm-2">
                                            <div class="btn-group" data-toggle="buttons">
                                                <a class="active-bttn btn btn-primary active">
                                                    ...
                                                    if (isset($capacityunits) && $capacityunits->status == 'active') {
                                                        echo "checked";
                                                    }
                                                    ?>>
                                                    Active
                                                ...
                                                <a class="inactive-btn btn btn-danger">
                                                    ...
                                                    if (isset($capacityunits) && $capacityunits->status == 'inactive') {
                                                        echo "checked";
                                                    }
                                                    ?>>
                                                    Inactive
                    ...
                    <div class="card-footer card-footer-box">
                        ...
                        <a href="{{url('admin/capacityunits')}}"><button type="button" class="btn btn-danger">Cancel</button></a>	
                    </div>  						
