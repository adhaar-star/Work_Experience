        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="dashboard-buttons">
                    @if (RoleAuthHelper::hasAccess('goods_receipt.create')!=true)  
                    ...
                    <div class="margin-bottom-50 display-block padding-top-10">
                        <table class="table table-inverse" id="example3" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        @if (RoleAuthHelper::hasAccess('goods_receipt.view')!=true)  
                                        {{$bill->id}}
                                        @else
                                        <a data-toggle="modal" data-target="#table-view-popup_{{$bill->id }}">
                                            {{$bill->id}}
                                            @endif
                                        </a>
                                    </td>
                                    ...
                                    <td class="action-btn">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-default btn-xs margin-right-1" style="cursor:no-drop; color:#97A7A7;">
                                            @else
                                            <a href="#" class="btn btn-info btn-xs margin-right-1" data-toggle="modal" data-target="#table-view-popup_{{$bill->id}}">@endif<i class="fa fa-eye" aria-hidden="true"></i> <!--view--> </a>
                                            {!! Form::open(array('route' => array('goods_receipt.reversal',$bill->id), 'method' => 'DELETE','id'=>'delform'.$bill->id)) !!}
                                            @if (RoleAuthHelper::hasAccess('goods_receipt.reversal')!=true)  
                                            <a href="javascript:void(0)" class="btn btn-default btn-xs margin-right-1" style="cursor:no-drop; color:#97A7A7;">
