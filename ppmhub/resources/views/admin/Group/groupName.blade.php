...
@section('title','Settings | Group |Edit Group')
@section('body')
@if (count($errors) > 0)
                    ...
                    <div class="col-md-12">
                        <div class="margin-bottom-50 margin-top-25">
                            <table class="tableizer-table table table-bordered text-center" border="1" style="width: 40%;">
                                ...
                                <tbody> 
                                    {!! Form::open(array('route'=>array('group.update',$group_edit->id),'method' => 'put','id'=>'group')) !!}
                                    <tr id="editInquiry_{{$group_edit->id}}" class="range">
                                        <td class="startrange">
                                            {!!Form::text('group_name',$group_edit->group_name,array('class'=>'form-control border-radius-0 group_name','id'=>'group_name'))!!}
                                        </td>
                                        <td> 
