...
@section('title','Create Customer Inquiry')
@section('body')
            ...
            <div class="col-lg-12">
                ...
                <div class="margin-bottom-50">
                    <ul class="list-unstyled breadcrumb breadcrumb-custom">
                        ...
                        <li>
                            <span>Create Customer Inquiry</span>
                        </li>
                    </ul>
                </div>
                <div class="card">
                    <div class="card-header card-header-box bg-lightcyan">
                        <h4 class="margin-0">Create Customer Inquiry</h4>
                    </div>
                    <div class="card-block">
                        <div class="ppm-tabpane">
                            ...
                            <!-- Tab panes -->
                            {{ csrf_field() }} 
                            <form id="cutomer_inquiry" method="post" name="customerInquiry" class="custInquiry">
                                    ...
                                    <div class="tab-pane active" id="inquiry-desc" role="tabpanel">
                                        ...
                                        <div class="tab-block">
                                            <div class="form-group row">
                                                {!!Form::textarea('inquiry_description','',array('class'=>'form-control header_note  border-radius-0 no-resize','placeholder'=>'Please enter inquiry detailed description','maxlength'=>255))!!}
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            <div class="form-input-icon">
                                                                {!!Form::text('inquiry_number',$inquiry_number,array('class'=>'form-control border-radius-0','readonly'))!!}
                                                                @if($errors->has('inquiry_number')) 
                                                                <div style='color:red'>
                                                                    {{ $errors->first('inquiry_number') }}
                                                                </div> 
                                                ...
                                                <div class="col-sm-6"> 
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            <div class="form-input-icon">                                               
                                                                {!!Form::select('inquiry_type',$inquirytype,'',array('class'=>'form-control border-radius-0 select2','placeholder'=>'Please select inquiry type','id'=>'inquiry_type'))!!}
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            <div class="form-input-icon">
                                                                {!!Form::text('inquiry_gross_price','',array('class'=>'form-control border-radius-0','readonly','placeholder'=>'Gross Price'))!!}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('inquiry_discount_amt','',array('class'=>'form-control border-radius-0','placeholder'=>'Discount amount','readonly'))!!}  
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('inquiry_sales_taxamt','',array('class'=>'form-control border-radius-0','placeholder'=>'Sales tax amount','readonly'))!!}  
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-xs-12 col-sm-6 col-md-4 col-form-label">Freight charges:</label>
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('inquiry_freight_charges','',array('class'=>'form-control border-radius-0','placeholder'=>'Please enter freight charges'))!!}  
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            <div class="form-input-icon">
                                                                {!!Form::text('inquiry_discount','',array('class'=>'form-control border-radius-0','placeholder'=>'Please enter discount'))!!}
                                                            </div>
                                                        </div>
                                                    </div> 
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('inquiry_discount_gross_price','',array('class'=>'form-control border-radius-0','placeholder'=>'Discount gross price','readonly'))!!}  
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-xs-12 col-sm-6 col-md-4 col-form-label">Net Price:</label>
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('inquiry_net_price','',array('class'=>'form-control border-radius-0','placeholder'=>'Net price','readonly'))!!}  
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('inquiry_total_price','',array('class'=>'form-control border-radius-0','placeholder'=>'Total price','readonly'))!!}  
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                {!!Form::hidden('inquiry_number',$inquiry_number,array('class'=>'form-control border-radius-0','readonly'))!!}
                            </form>
                        </div>
                        <table class="table table-list table-responsive margin-top-15 margin-bottom-40">
                            ...
                            <tbody id='purchase_item_form'>
                                ...
                                <tr id='purchase_item_0' class = "form">
                                    ...
                                    {!!Form::hidden('inquiry_number',$inquiry_number)!!}
                            ...
                            <form id="Purchase_requisition_two">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="Condition" role="tabpanel">
                                        ...
                                        <div class="tab-block">
                                            <div class="form-group row">
                                                {!!Form::textarea('short_description','',array('class'=>'form-control border-radius-0','placeholder'=>'Please enter inquiry short description'))!!}                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            <div class="form-input-icon">
                                                                {!!Form::text('gross_price','',array('class'=>'form-control border-radius-0','readonly','placeholder'=>'Gross Price'))!!}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                            {!!Form::text('created_on',$inquiry_createdDate,array('class'=>'form-control border-radius-0','readonly'))!!}  
                                                        </div>
                                                    </div>
...
<script type="text/javascript">
    ...
    $.ajax({
    url: "{{url('/admin/customer_inquiry/store')}}",
            method: "POST",
