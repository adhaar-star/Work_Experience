...
@section('title','Create Returns Budget')
@section('body')

{!! Html::script('/js/generate_textbox.js') !!}
{!! Html::script('/js/jquery.validate.min.js') !!}
{!! Html::script('/js/budget_return_validation.js') !!}
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                if (isset($getReturnBudget) && $getReturnBudget->id) {
                    echo url('admin/projectbudget/returns/update/' . $getReturnBudget->id);
                } else {
                    echo url('admin/projectbudget/returns/store');
                }
                ?>" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                    ...
                    <div class="margin-bottom-50">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                {!!Form::select('project_id',$project_id,isset($getReturnBudget->project_id) ? $getReturnBudget->project_id : '',array('class'=>'form-control select2 ','placeholder'=>'Select Project id','id'=>'ProjectListGet'))!!}  
                                                ...
                                                <div class="form-input-icon">
                                                    <?php if (isset($getReturnBudget)) { ?>
                                                        <select name="period_from" class="form-control select2" id="period_from">
                                                            ...
                                                            <option value="{{$i}}"<?php if ($i == $getReturnBudget->period_from) echo ' selected="selected"'; ?>>{{$i}}</option>
                                                            @endfor
                                                        </select>
                                                    <?php } else { ?>
                                                        <select name="period_from" class="form-control select2" id="period_from">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                <?php if (isset($getReturnBudget)) { ?>
                                                    <select name="period_to" class="form-control select2" id="period_to">
                                                        ...
                                                        @for($i = $year - 5; $i <= $year + 5; $i++)
                                                        <option value="{{$i}}"<?php if ($i == $getReturnBudget->period_to) echo ' selected="selected"'; ?>>{{$i}}</option>
                                                        @endfor
                                                    </select>
                                                <?php } else { ?>
                                                    <select name="period_to" class="form-control select2" id="period_to">
                                      ...
                                      <!--<input type="text" class="form-control border-radius-0 datepicker-init" data-validation="[NOTEMPTY]" placeholder="Period To" id="period_to" name="period_to">-->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7 message">
                                                <?php if (isset($getReturnBudget)) { ?>
                                                    <input type="text" class="form-control border-radius-0" value="{{$getReturnBudget->overall}}" data-validation="[NOTEMPTY]" placeholder="Overall" id="overall" name="overall">
                                                <?php } else { ?>
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        ...
                                        <div class="form-group row" id="dynamic_tb"> 
                                            ...
                                            <!--GENERATE TEXTBOX AT EDIT TIME-->
                                            <?php if (isset($getReturnBudget->year1)) { ?>  
                                                <div class="form-group row">
                                                    <label class="col-xs-12 col-sm-6 col-md-4 col-form-label">Year : {{$years}}</label>
                                                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">                                                    
                                                        <input type="text" id="year1" name="year1" value="{{$getReturnBudget->year1}}"  class="dynmctb form-control border-radius-0" data-validation="[NOTEMPTY]">                                                                             
                                                    </div>
                                                </div>
                                            <?php } ?>  
                                            <?php if (isset($getReturnBudget->year2)) { ?>  
                                                <div class="form-group row">
                                                    <label class="col-xs-12 col-sm-6 col-md-4 col-form-label">Year : {{$years+1}}</label>
                                                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">                                                    
                                                        <input type="text" id="year1" name="year2" value="{{$getReturnBudget->year2}}"  class="dynmctb form-control border-radius-0" data-validation="[NOTEMPTY]">                                                                             
                                                    </div>
                                                </div>
                                            <?php } ?>  
                                            <?php if (isset($getReturnBudget->year3)) { ?>  
                                                <div class="form-group row">
                                                    <label class="col-xs-12 col-sm-6 col-md-4 col-form-label">Year : {{$years+2}}</label>
                                                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">                                                    
                                                        <input type="text" id="year1" name="year3" value="{{$getReturnBudget->year3}}"  class="dynmctb form-control border-radius-0" data-validation="[NOTEMPTY]">                                                                             
                                                    </div>
                                                </div>
                                            <?php } ?>  
                                            <?php if (isset($getReturnBudget->year4)) { ?>  
                                                <div class="form-group row">
                                                    <label class="col-xs-12 col-sm-6 col-md-4 col-form-label">Year : {{$years+3}}</label>
                                                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">                                                    
                                                        <input type="text" id="year1" name="year4" value="{{$getReturnBudget->year4}}"  class="dynmctb form-control border-radius-0" data-validation="[NOTEMPTY]">                                                                             
                                                    </div>
                                                </div>
                                            <?php } ?>  
                                            <?php if (isset($getReturnBudget->year5)) { ?>  
                                                <div class="form-group row">
                                                    <label class="col-xs-12 col-sm-6 col-md-4 col-form-label">Year : {{$years+4}}</label>
                                                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">                                                    
                                                        <input type="text" id="year1" name="year5" value="{{$getReturnBudget->year5}}"  class="dynmctb form-control border-radius-0" data-validation="[NOTEMPTY]">                                                                             
                                                    </div>
                                                </div>
                                            <?php } ?>  
                        ...
                        <div class="card-footer card-footer-box text-right">
                            ...
                            <a href="{{url('admin/returnbudget')}}"><button type="button" class="btn btn-danger">Cancel</button></a>
                        </div>
                        <!-- End Vertical Form -->
                    </div>
                </form>
