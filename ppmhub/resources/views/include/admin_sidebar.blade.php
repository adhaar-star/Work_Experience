<div class="togle-btn pull-right">
					<div class="dropdown inner-drpdwn">
						...
						<ul class="dropdown-menu" aria-labelledby="" role="menu">
									...
									<a class="dropdown-item" href="{{url('admin/costcentretype')}}">Cost Centre</a>
									<a class="dropdown-item" href="{{url('admin/location')}}">Project Location</a>
									<a class="dropdown-item" href="{{url('admin/factorycalendar')}}">Factory Calender</a>
