	...
	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <a href="{{url('admin/portfoliotypes/create')}}" class="btn btn-sm btn-primary pull-right">Add Portfolio Type</a>
                        ...
                        @foreach($portfoliotype as $type)
                        	<tr>
                        		...
                        		<td style="text-align: center;">
                        			<a href="{{url('admin/portfoliotypes/'.$type->id.'/edit')}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                        			<form action="{{url('admin/portfoliotypes/'.$type->id)}}" method="post" id="delform">
                        			{{ method_field('DELETE') }}
                        			{{ csrf_field() }}
