...
@section('body')
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Buckets</h2>
                    <a href="{{url('admin/buckets/create')}}" class="btn btn-sm btn-primary pull-right">Create Bucket</a>
                      ...
                      <tbody>
					    @foreach($buckets as $buck)
                        	<tr>
                        		...
                        		<td>{{$buck->created_date }}</td>
                        		<td>{{$buck->created_by }}</td>
                        		<td>{{$buck->currency }}</td>
                        		<td>{{$buck->initiatives }}</td>
