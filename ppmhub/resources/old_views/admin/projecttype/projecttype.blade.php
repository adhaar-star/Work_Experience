...
@section('body')
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Project Type</h2>
                    <a href="{{url('admin/projecttype/create')}}" class="btn btn-sm btn-primary pull-right">Add Project Type</a>
                        ...
                        @foreach($projecttypes as $type)
                        	<tr>
                        		...
                        		<td style="text-align: center;">
                        			<a href="{{url('admin/projecttypes/'.$type->id.'/edit')}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                        			<form action="{{url('admin/projecttypes/'.$type->id)}}" method="post" id="delform">
                        			{{ method_field('DELETE') }}
                        			{{ csrf_field() }}
