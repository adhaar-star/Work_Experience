...
internal_meta.push({name: "type", label: "Type", datatype: "string", 'editable': true, 'values': {'Capex': 'Capex', 'Opex': 'Opex'}});
    ...
    internalCostPlan = new EditableGrid("internalCost", {
        ...
        modelChanged: function (rowIdx, colIdx, oldValue, newValue, row) {
            ...
            if (colIdx == 3)
            {
                ...
                {
                    $.ajax({
                        url: "/../admin/projectcostplan/getresource/0",
                        method: "POST",
            ...
            if (row.id != 'internalCost_total_cost') { // ignore the last row
                ...
                if (row.id.indexOf('add') == -1) { //update cost 
                    ...
                    if (flag == true) {
                        ...
                        update_cost('internal', dataObj, id);
