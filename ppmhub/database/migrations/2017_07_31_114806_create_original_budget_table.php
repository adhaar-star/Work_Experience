...
class CreateOriginalBudgetTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('budget_original', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('original_budget')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('original_budget');
    }
}
