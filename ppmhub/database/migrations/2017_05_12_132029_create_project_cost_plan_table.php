...
class CreateProjectCostPlanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
      Schema::create('project_cost_plan', function (Blueprint $table) {
            ...
            $table->string('cost_plan_Id',255)->nullable();
            $table->string('cost_plan_name',255)->nullable();
            $table->string('cost_plan_type',255)->nullable();
