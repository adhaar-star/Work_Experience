...
//                    'planning_unit' => 'required',
    ...
    public function edit($id) {
        ...
        return view('admin.portfolioresourceplanning.create', compact('Currencyunit', 'portfolioresourceplanning', 'buckets', 'portfolio', 'planning_type', 'costing_type', 'collection_type', 'view_type', 'Planningunit'));
    }
...
//                    'planning_unit' => 'required',
        ...
        if ($validator->fails()) {
            $msgs = $validator->messages();
            return redirect('admin/portfolioresourceplanning/' . $id . '/edit')->withErrors($validator)->withInput($request->all());
        }
