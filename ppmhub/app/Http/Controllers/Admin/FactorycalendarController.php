...
class FactorycalendarController extends Controller {
  ...
  public function index() {
    $factorycalendar = factorycalendar::where('company_id', Auth::user()->company_id)->get();
  ...
  public function store(Request $request) {
    ...
    $factoryData = Input::all();
    $factoryData['company_id'] = Auth::user()->company_id;
    print_r($factoryData);exit;
    Factorycalendar::create($factoryData);
