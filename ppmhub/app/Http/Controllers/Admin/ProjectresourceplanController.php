...
class ProjectresourceplanController extends Controller
{
    ...
    public function index()
    {
        ...
        $resourceData = DB::table('createrole')
                ...
                ->join('assignrole', 'createrole.id', '=', 'assignrole.role')
                ->rightjoin('employee_records', 'assignrole.resource_name', '=', 'employee_records.employee_id')
                ->rightjoin('taskassign', 'createrole.id', '=', 'taskassign.role')
                ->rightjoin('tasks_subtask', 'taskassign.task', '=', 'tasks_subtask.id')
                ->rightjoin('project', 'assignrole.project_id', '=', 'project.id')
