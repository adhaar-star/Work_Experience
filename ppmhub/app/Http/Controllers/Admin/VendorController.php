...
class VendorController extends Controller {
    ...
    public function index() {
        Roleauth::check('procurement.vendor.index');
    ...
    public function create() {
        Roleauth::check('procurement.vendor.create');
    ...
    public function edit($id) {
        Roleauth::check('procurement.vendor.edit');
    ...
    public function destroy($id) {
        Roleauth::check('procurement.vendor.delete');
    ...
    public function export_cs() {
        Roleauth::check('procurement.vendor.export');
    ...
    public function importExport() {
        Roleauth::check('procurement.vendor.import.csv');
    ...
    public function importExcel(Request $request) {
        Roleauth::check('procurement.vendor.import.excel');
