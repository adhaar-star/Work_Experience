...
data.push({id: 4, values: {'period': 'PLANNED REVENUE', 'total': 0}});
forcast_data = data;
$(document).ready(function () {
    ...
    $('#adjustforecast').on('click', function(){
      ...
      if(projectId != '' && projectId != 0 && projectId != undefined){
        $.ajax({
            url: "/admin/revenueforcast/project/" + projectId+"/adjust",
            method: "POST",
            dataType: "JSON",
            data:{'_token': token},
    ...
    $('#projectId').on('change', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.ajax({
                    url: "/admin/revenueforcast/project/" + project_id,
                    method: "POST",
                    data: {'_token': token},
                    dataType: "JSON",
                    success: function (result) {
