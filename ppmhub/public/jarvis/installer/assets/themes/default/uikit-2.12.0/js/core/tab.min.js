    ...
    i.component("tab", {
        defaults: {
            ...
            this.on("click", this.options.target, function (i) {
                ...
                var s = t(this);
                e.element.children(":not(.uk-tab-responsive)").eq(s.data("index")).trigger("click")
            ...
            if (!(i.length < 2)) {
                var e, s, n = i.eq(0).offset().top + Math.ceil(i.eq(0).height() / 2), o = !1;
                if (this.responsivetab.lst.empty(), i.each(function () {
                        t(this).offset().top > n && (o = !0)
                    }), o)for (var a = 0; a < i.length; a++)e = i.eq(a), s = e.find("a"), "none" == e.css("float") || e.attr("uk-dropdown") || (e.addClass("uk-hidden"), e.hasClass("uk-disabled") || this.responsivetab.lst.append('<li><a href="' + s.attr("href") + '" data-index="' + a + '">' + s.html() + "</a></li>"));
