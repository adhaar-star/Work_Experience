<?php /* Smarty version 2.6.16, created on 2017-03-07 11:57:34
         compiled from MachineEntry.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'MachineEntry.tpl', 15, false),array('modifier', 'string_format', 'MachineEntry.tpl', 23, false),)), $this); ?>
...
<table class="dataTable tabledetails" width="100%" cellspacing="0">
<tr>
...
" onchange="xajax_ProcessForm('','MachineEntry', xajax.getFormValues('machineEntryForm'))"></td>
</tr>
...
<input type="submit" value="Update" class="clickable" onclick="xajax_ProcessForm('','MachineEntry', xajax.getFormValues('machineEntryForm'))">
<input type="button" value="Done" class="clickable" onclick="xajax_ProcessForm('','MachineEntry', xajax.getFormValues('machineEntryForm'));xajax_HideDiv('dataDetailsArea');document.getElementById('siteEntryForm').refNumber.select()">
