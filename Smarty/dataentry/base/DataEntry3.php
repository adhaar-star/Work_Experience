...
class DataEntry3 {
	...
	public function GetResponse(xajaxResponse $objResponse) {
		if(sizeof($this->errors) == 0) {
			...
			$objResponse->addAssign('siteInfo2', 'innerHTML', SiteInfo3::Display($data));
			$objResponse->addAppend('siteInfo2', 'innerHTML', MachineEntry3::Display($data));
		}
	...
	public static function GetMenu() {
		...
		$menu->AddItem("TVR", "DataEntry3", array("siteType" => "TVR") );
		$menu->AddItem("MVN", "DataEntry3", array("siteType" => "MVN") );
