...
class Reports {
	...
	public function GetResponse($objResponse) {
		$objResponse->addAssign('reportArea', 'innerHTML', $this->{'Report'.$this->formData['report']}());
		return $objResponse;
	}
...
//print_r($result);
	...
	public function Report4() {
		$siteType = $this->formData['siteType'];
		$inactive = $this->formData['inactive'];
		$newsubmenu = $this->formData['newsubmenu'];
		...
		$tpl->Assign('siteType', $siteType);
		$tpl->Assign('newsubmenu', $newsubmenu);
		$out .= $tpl->GetHtml();
