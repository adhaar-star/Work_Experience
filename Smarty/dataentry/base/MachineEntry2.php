...
return $values;
	...
	public static function Display($data) {
		...
		$tpl = new Template("MachineEntry2");
		...
		$date = new Date();
		$tpl->Assign('dateSelect', $date->GetFormField('date', date(DATE_FORMAT_MYSQL), "xajax_ProcessForm3('','MachineEntry2', xajax.getFormValues('machineEntryForm'))"));
