		...
		<div class="main" style="max-width:100%;">
		    <div class="container" style="max-width:100%;">
		        <header class="header clearfix">
					 <div class="ship-no-blk" style="float:right">
						 <p class="ship-head"><strong>Order Confirmation</strong></p>
		        ...
		        <section class="top-blk clearfix" style="float:left;width:100%">
		            <div class="main-heading" style="float:left;width:100%">
		                <p class="name-heading"><strong>Hello {{ $order->name }},</strong></p>
						<p class="sub-cnt">Good news! Your product Apple iPhone 6 has been sold. Kindly keep the product ready to ship for pickup by our haggler team.</p>
			               <ul><li>Remember to ship the product in original packaging with all tags intact.</li><li>Enclose return related labels and information.</li><li>Payment will be credited as per terms.</li></ul>
						 <p class="sub-cnt">Thanks & Good luck.</p>
						<p class="sub-cnt">Team Haggler</p>
						<p class="order-no">Order #{{ $order->id }}</p>			
		            </div>
		        </section>
		        <section class="order-desc" style="float:left;width:100%">
		 ...
		 <p><span class="green">GO GREEN.</span>You will receive a soft copy of an invoice as a part of the delivery confirmation email within 24 hours of the delivery completion.</p>
  <p>Do shop with us again!</p>
					<strong><p>Team haggler</p></strong>
				</div>
