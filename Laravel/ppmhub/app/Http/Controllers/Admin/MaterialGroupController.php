...
class MaterialGroupController extends Controller {
    ...
    public function store(Request $request) {
        ...
        session()->flash('flash_message', 'Material group created successfully...');
    ...
    public function update(Request $request, $id) {
        ...
        session()->flash('flash_message', 'Material group updated successfully...');
        return redirect('admin/addGroup');
    }
    ...
    public function destroy($id) {
        ...
        session()->flash('flash_message', 'Material group deleted successfully...');
        return redirect('admin/addGroup');
    }
