...
class ServiceController extends Controller {
  ...
  public function index() {
    Roleauth::check('procurement.service.index');
  ...
  public function create() {
    Roleauth::check('procurement.service.create');
  ...
  public function edit($id) {
    Roleauth::check('procurement.service.edit');
  ...
  public function destroy($id) {
    Roleauth::check('procurement.service.delete');
