...
class ProjectschedulingController extends Controller
{
    ...
    {
        return view('admin.projectscheduling.dashboard');
    }
    ...
    public function create()
    {
        ...
        return view('admin.projectscheduling.create', compact('category', 'prjId', 'port', 'ptype', 'buckets', 'projectType', 'location', 'currency', 'personresponsible', 'factorycalendar', 'cost_centre', 'department'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.projectscheduling.create', compact('lower_bucket', 'category', 'actual_progress', 'planned_progress', 'cost_prop_progress', 'phy_progress', 'Net_Total', 'modifiedby', 'createdby', 'port', 'project', 'ptype', 'buckets', 'projectType', 'currency', 'location', 'personresponsible', 'factorycalendar', 'cost_centre', 'department'));
    }
    ...
    public function update(Request $request, $id)
    {
        $project = Project::where('company_id', Auth::user()->company_id)->find($id);
        if (!isset($project)) {
            return redirect('admin/projectscheduling');
        }
        ...
        if ($start_date > $end_date) {
            ...
            return redirect('admin/projectscheduling/' . $id . '/edit')->withErrors($msgs)->withInput(Input::all());
        }
        ...
        if ($validator->fails()) {
            $msgs = $validator->messages();
            return redirect('admin/projectscheduling/' . $id . '/edit')->withErrors($validator)->withInput(Input::all());
        }
