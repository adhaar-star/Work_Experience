...
class MaterialMasterController extends Controller {
    ...
    public function index() {
       // Roleauth::check('procurement.material.index');
...
//        $material_master = materialmaster::all();
    ...
    public function create() {
        Roleauth::check('procurement.material.create');
    ...
    public function edit($id) {
        Roleauth::check('procurement.material.edit');
    ...
    public function destroy($id) {
        Roleauth::check('procurement.material.delete');
