...
!function (t) {
    ...
    "use strict";
    var n = i.UIkit || {}, o = i("html"), s = i(window), a = i(document);
    if (n.fn)return n;
    if (n.version = "2.12.0", n.$doc = a, n.$win = s, n.$html = o, n.fn = function (t, e) {
            ...
            var i, e, n, o, s, a, r, l, u, c;
            t && setTimeout(function () {
                try {
                    for (c = document.styleSheets, o = 0, r = c.length; r > o; o++) {
                        for (n = c[o], e = [], n.cssRules = n.cssRules, i = s = 0, l = n.cssRules.length; l > s; i = ++s)n.cssRules[i].type === CSSRule.STYLE_RULE && t.test(n.cssRules[i].selectorText) && e.unshift(i);
                        for (a = 0, u = e.length; u > a; a++)n.deleteRule(e[a])
                    }
                } catch (h) {
                }
            }, 0)
            ...
            return e = i.extend({
                topoffset: 0,
                leftoffset: 0
            }, e), u + n.height() >= a && u - e.topoffset <= a + s.height() && l + n.width() >= o && l - e.leftoffset <= o + s.width() ? !0 : !1
        }, n.Utils.checkDisplay = function (t, e) {
            var n = i("[data-uk-margin], [data-uk-grid-match], [data-uk-grid-margin], [data-uk-check-display]", t || document);
            return t && !n.length && (n = i(t)), n.trigger("uk.check.display"), e && ("string" != typeof e && (e = '[class*="uk-animation-"]'), n.find(e).each(function () {
                var t = i(this), e = t.attr("class"), n = e.match(/uk\-animation\-(.+)/);
            ...
            var o = i.Deferred();
            return t = i(t), t.css("display", "none").addClass(e).one(n.support.animation.end, function () {
                t.removeClass(e), o.resolve()
            }).width(), t.css("display", ""), o.promise()
        }, n.Utils.template = function (t, i) {
            for (var e, n, o, s, a = t.replace(/\n/g, "\\n").replace(/\{\{\{\s*(.+?)\s*\}\}\}/g, "{{!$1}}").split(/(\{\{\s*(.+?)\s*\}\})/g), r = 0, l = [], u = 0; r < a.length;) {
            ...
            var c = new Function("$data", s);
            return i ? c(i) : c
        }, n.Utils.events = {}, n.Utils.events.click = n.support.touch ? "tap" : "click", i.UIkit = n, i.fn.uk = n.fn, i.UIkit.langdirection = "rtl" == o.attr("dir") ? "right" : "left", n.components = {}, n.component = function (t, e) {
            var o = function (e, n) {
                var s = this;
                ...
                }), this.trigger("uk.component.init", [t, this])
            };
            return o.plugins = {}, i.extend(!0, o.prototype, {
                defaults: {plugins: []}, init: function () {
                }, on: function () {
            ...
            return 2 == arguments.length && 0 === arguments[0].indexOf("uk.domready") && n.domready && arguments[1].apply(a), a.on.apply(a, arguments)
        }, n.one = function () {
            return 2 == arguments.length && 0 === arguments[0].indexOf("uk.domready") && n.domready ? (arguments[1].apply(a), a) : a.one.apply(a, arguments)
        }, n.trigger = function (t, i) {
            return a.trigger(t, i)
        }, n.domObserve = function (t, e) {
            n.support.mutationobserver && (e = e || function () {
            }, i(t).each(function () {
                var t = this, o = i(t);
                if (!o.data("observer"))try {
                    var s = new n.support.mutationobserver(n.Utils.debounce(function () {
                        e.apply(t, []), o.trigger("uk.dom.changed")
                    }, 50));
                    s.observe(t, {childList: !0, subtree: !0}), o.data("observer", s)
                } catch (a) {
                }
            }))
        }, n.ready(function (t) {
            n.domObserve(i("[data-uk-observe]", t || document))
        }), n.on("uk.domready", function () {
            n.domObservers.forEach(function (t) {
                t(document)
            }), n.domready && n.Utils.checkDisplay(document)
        }), n.on("uk.dom.changed", function (t) {
            var i = t.target;
            n.domObservers.forEach(function (t) {
                t(i)
            }), n.Utils.checkDisplay(i)
        }), i(function () {
            n.trigger("uk.domready.before"), setInterval(function () {
                var t = {x: window.pageXOffset, y: window.pageYOffset}, e = function () {
            ...
            }(), 15), n.trigger("uk.domready"), n.support.touch && navigator.userAgent.match(/(iPad|iPhone|iPod)/g) && n.$win.on("load orientationchange resize", n.Utils.debounce(function () {
                var t = function () {
                    return i(".uk-height-viewport").css("height", window.innerHeight), t
                };
                return t()
            }(), 100)), n.trigger("uk.domready.after"), n.domready = !0
        }), o.addClass(n.support.touch ? "uk-touch" : "uk-notouch"), n.support.touch) {
        var r, l = !1, u = ".uk-overlay, .uk-overlay-toggle, .uk-caption-toggle, .uk-animation-hover, .uk-has-hover";
        o.on("touchstart MSPointerDown pointerdown", u, function () {
            l && i(".uk-hover").removeClass("uk-hover"), l = i(this).addClass("uk-hover")
        }).on("touchend MSPointerUp pointerup", function (t) {
            r = i(t.target).parents(u), l && l.not(r).removeClass("uk-hover")
        })
    }
    return n
}), function (t) {
    ...
    i.component("stackMargin", {
        defaults: {cls: "uk-margin-small-top"}, init: function () {
            var n = this;
            ...
            var i = this;
            this.revert();
            var e = !1, n = this.columns.filter(":visible:first"), o = n.length ? n.offset().top : !1;
...
}(jQuery, jQuery.UIkit), function (t, i) {
    "use strict";
    function e(e, n) {
        n = t.extend({
        ...
        var o = e.offset().top - n.offset, s = i.$doc.height(), a = window.innerHeight;
        o + a > s && (o = s - a), t("html,body").stop().animate({scrollTop: o}, n.duration, n.transition).promise().done(n.complete)
    }
    ...
    }), i.Utils.scrollToElement = e, t.easing.easeOutExpo || (t.easing.easeOutExpo = function (t, i, e, n, o) {
    ...
    "use strict";
    var e = i.$win, n = i.$doc, o = [], s = function () {
    ...
    i.component("scrollspynav", {
        defaults: {
            ...
            var n, o = [], s = this.find("a[href^='#']").each(function () {
                o.push(t(this).attr("href"))
            }), r = t(o.join(",")), l = this, u = function () {
                n = [];
                for (var t = 0; t < r.length; t++)i.Utils.isInView(r.eq(t), l.options) && n.push(r.eq(t));
                if (n.length) {
                    var o, a = e.scrollTop(), u = function () {
                        for (var t = 0; t < n.length; t++)if (n[t].offset().top >= a)return n[t]
                    }();
                    if (!u)return;
                    o = l.options.closest ? s.closest(l.options.closest).removeClass(l.options.cls).end().filter("a[href='#" + u.attr("id") + "']").closest(l.options.closest).addClass(l.options.cls) : s.removeClass(l.options.cls).filter("a[href='#" + u.attr("id") + "']").addClass(l.options.cls), l.element.trigger("uk.scrollspynav.inview", [u, o])
                }
            };
            this.options.smoothscroll && i.smoothScroll && s.each(function () {
                i.smoothScroll(this, l.options.smoothscroll)
            }), u(), this.element.data("scrollspynav", this), this.check = u, a.push(this)
        }
    });
    var l = function () {
        s(), r()
...
}(jQuery, jQuery.UIkit), function (t, i, e) {
    "use strict";
    var n = [];
    e.component("toggle", {
        defaults: {target: !1, cls: "uk-hidden", animation: !1, duration: 200}, init: function () {
            var t = this;
            this.getTogglers(), this.on("click", function (i) {
                t.element.is('a[href="#"]') && i.preventDefault(), t.toggle()
            }), n.push(this)
        }, toggle: function () {
            if (this.totoggle.length)if (this.options.animation) {
                var t = this, n = this.options.animation.split(",");
                1 == n.length && (n[1] = n[0]), n[0] = n[0].trim(), n[1] = n[1].trim(), this.totoggle.css("animation-duration", this.options.duration + "ms"), this.totoggle.hasClass(this.options.cls) ? (this.totoggle.toggleClass(this.options.cls), this.totoggle.each(function () {
                    e.Utils.animate(this, n[0]).then(function () {
                        i(this).css("animation-duration", ""), e.Utils.checkDisplay(this)
                    })
                })) : this.totoggle.each(function () {
                    e.Utils.animate(this, n[1] + " uk-animation-reverse").then(function () {
                        i(this).toggleClass(t.options.cls).css("animation-duration", ""), e.Utils.checkDisplay(this)
                    }.bind(this))
                })
            } else this.totoggle.toggleClass(this.options.cls), e.Utils.checkDisplay(this.totoggle)
...
}(this, jQuery, jQuery.UIkit), function (t, i) {
    "use strict";
    i.component("alert", {
        defaults: {fade: !0, duration: 200, trigger: ".uk-alert-close"}, init: function () {
            var t = this;
    ...
    i.component("buttonRadio", {
        defaults: {target: ".uk-button"}, init: function () {
            var i = this;
        ...
        if (!n.data("buttonCheckbox")) {
            var o = i.buttonCheckbox(n, i.Utils.options(n.attr("data-uk-button-checkbox"))), s = t(e.target);
    ...
    i.component("dropdown", {
        defaults: {mode: "hover", remaintime: 800, justify: !1, boundary: i.$win, delay: 0},
        remainIdle: !1,
        init: function () {
            var n = this;
        ...
        show: function () {
            i.$html.off("click.outer.dropdown"), n && n[0] != this.element[0] && n.removeClass("uk-open"), e && clearTimeout(e), this.checkDimensions(), this.element.addClass("uk-open"), this.trigger("uk.dropdown.show", [this]), i.Utils.checkDisplay(this.dropdown, !0), n = this.element, this.registerOuterClick()
        },
        hide: function () {
        ...
        registerOuterClick: function () {
            var o = this;
            i.$html.off("click.outer.dropdown"), setTimeout(function () {
        ...
        checkDimensions: function () {
            if (this.dropdown.length) {
                ...
                var i = this, e = this.dropdown.css("margin-" + t.UIkit.langdirection, ""), n = e.show().offset(), o = e.outerWidth(), s = this.boundary.width(), a = this.boundary.offset() ? this.boundary.offset().left : 0;
                if (this.centered && (e.css("margin-" + t.UIkit.langdirection, -1 * (parseFloat(o) / 2 - e.parent().width() / 2)), n = e.offset(), (o + n.left > s || n.left < 0) && (e.css("margin-" + t.UIkit.langdirection, ""), n = e.offset())), this.justified && this.justified.length) {
                    ...
                    if (e.css("min-width", r), "right" == t.UIkit.langdirection) {
                        var l = s - (this.justified.offset().left + r), u = s - (e.offset().left + e.outerWidth());
                        e.css("margin-right", l - u)
    ...
    i.component("gridMatchHeight", {
        defaults: {target: !1, row: !0}, init: function () {
            var n = this;
            ...
            if (i.length) {
                var e = Math.ceil(100 * parseFloat(i.css("width")) / parseFloat(i.parent().css("width"))) >= 100 ? !0 : !1, n = this;
                if (!e)return this.options.row ? (this.element.width(), setTimeout(function () {
                    var i = !1, e = [];
                    n.elements.each(function () {
                        var o = t(this), s = o.offset().top;
            ...
            if (!(i.length < 2)) {
                ...
                i.each(function () {
                    ...
                    var i = t(this), n = e - (i.outerHeight() - i.height());
                    i.css("min-height", n + "px")
                })
            }
        }
    }), i.component("gridMargin", {
        defaults: {cls: "uk-grid-margin"}, init: function () {
    ...
    var n, o = !1, s = t("html");
    i.component("modal", {
        defaults: {keyboard: !0, bgclose: !0, minScrollHeight: 150},
        scrollable: !1,
        transition: !1,
        init: function () {
            n || (n = t("body"));
        ...
        show: function () {
            if (!this.isActive())return o && o.hide(!0), this.element.removeClass("uk-open").show(), this.resize(), o = this, s.addClass("uk-modal-page").height(), this.element.addClass("uk-open").trigger("uk.modal.show"), i.Utils.checkDisplay(this.dialog, !0), this
        },
        hide: function (t) {
            if (this.isActive()) {
        ...
        init: function () {
            var e = this;
            this.options = t.extend({target: e.element.is("a") ? e.element.attr("href") : !1}, this.options), this.modal = i.modal(this.options.target, this.options), this.on("click", function (t) {
    ...
    i.component("nav", {
        ...
        open: function (i, n) {
            ...
            }), s.toggleClass("uk-open"), s.data("list-container") && (n ? s.data("list-container").stop().height(s.hasClass("uk-open") ? "auto" : 0) : s.data("list-container").stop().animate({height: s.hasClass("uk-open") ? e(s.data("list-container").find("ul:first")) : 0}))
        }
    }), i.ready(function (e) {
    ...
    "use strict";
    var e = {x: window.scrollX, y: window.scrollY}, n = (i.$win, i.$doc), o = i.$html, s = {
        show: function (i) {
            if (i = t(i), i.length) {
                var s = t("body"), a = i.find(".uk-offcanvas-bar:first"), r = "right" == t.UIkit.langdirection, l = a.hasClass("uk-offcanvas-bar-flip") ? -1 : 1, u = l * (r ? -1 : 1);
                e = {
                    x: window.pageXOffset,
                    y: window.pageYOffset
                }, i.addClass("uk-active"), s.css({
                    width: window.innerWidth,
                    height: window.innerHeight
                }).addClass("uk-offcanvas-page"), s.css(r ? "margin-right" : "margin-left", (r ? -1 : 1) * a.outerWidth() * u).width(), o.css("margin-top", -1 * e.y), a.addClass("uk-offcanvas-bar-show"), this._initElement(i), n.trigger("uk.offcanvas.show", [i, a])
            }
        }, hide: function (i) {
            var s = t("body"), a = t(".uk-offcanvas.uk-active"), r = "right" == t.UIkit.langdirection, l = a.find(".uk-offcanvas-bar:first"), u = function () {
                s.removeClass("uk-offcanvas-page").css({
                    width: "",
                    height: "",
                    "margin-left": "",
                    "margin-right": ""
                }), a.removeClass("uk-active"), l.removeClass("uk-offcanvas-bar-show"), o.css("margin-top", ""), window.scrollTo(e.x, e.y), n.trigger("uk.offcanvas.hide", [a, l])
            };
            a.length && (t.UIkit.support.transition && !i ? (s.one(t.UIkit.support.transition.end, function () {
                u()
            }).css(r ? "margin-right" : "margin-left", ""), setTimeout(function () {
                l.removeClass("uk-offcanvas-bar-show")
            }, 0)) : u())
        }, _initElement: function (e) {
            e.data("ukOffcanvasInit") || (e.on("click.ukoffcanvas swipeRight.ukoffcanvas swipeLeft.ukoffcanvas", function (i) {
                var e = t(i.target);
                ...
                i.stopImmediatePropagation(), s.hide()
            }), e.on("click", "a[href^='#']", function () {
                var e = t(this), o = e.attr("href");
                "#" != o && (n.one("uk.offcanvas.hide", function () {
                    var e = t(o);
                    e.length || (e = t('[name="' + o.replace("#", "") + '"]')), i.Utils.scrollToElement && e.length ? i.Utils.scrollToElement(e) : window.location.href = o
                }), s.hide())
            }), e.data("ukOffcanvasInit", !0))
        }
    };
    ...
    }), i.offcanvas = s, o.on("click.offcanvas.uikit", "[data-uk-offcanvas]", function (e) {
        e.preventDefault();
        var n = t(this);
    ...
    "use strict";
    function e(e, n, o) {
        var s, a = t.Deferred(), r = e, l = e;
        return o[0] === n[0] ? (a.resolve(), a.promise()) : ("object" == typeof e && (r = e[0], l = e[1] || e[0]), s = function () {
            n && n.hide().removeClass("uk-active " + l + " uk-animation-reverse"), o.addClass(r).one(i.support.animation.end, function () {
                o.removeClass("" + r).css({opacity: "", display: ""}), a.resolve(), n && n.css({
                    opacity: "",
                    display: ""
                })
            }.bind(this)).show()
        }, o.css("animation-duration", this.options.duration + "ms"), n && n.length ? (n.css("animation-duration", this.options.duration + "ms"), n.css("display", "none").addClass(l + " uk-animation-reverse").one(i.support.animation.end, function () {
            s()
        }.bind(this)).css("display", "")) : (o.addClass("uk-active"), s()), a.promise())
    }
    ...
    i.component("switcher", {
        ...
        init: function () {
            ...
            if (this.on("click", this.options.toggle, function (t) {
                ...
                n.length ? this.show(n, !1) : (n = e.eq(this.options.active), this.show(n.length ? n : e.eq(0), !1))
            }
        },
        show: function (o, s) {
            if (!this.animating) {
                o = isNaN(o) ? t(o) : this.find(this.options.toggle).eq(o);
                var a = this, r = o, l = n[this.options.animation] || function (t, i) {
                        if (!a.options.animation)return n.none.apply(a);
                        var o = a.options.animation.split(",");
                        return 1 == o.length && (o[1] = o[0]), o[0] = o[0].trim(), o[1] = o[1].trim(), e.apply(a, [o, t, i])
                    };
                s === !1 && (l = n.none), r.hasClass("uk-disabled") || (this.find(this.options.toggle).filter(".uk-active").removeClass("uk-active"), r.addClass("uk-active"), this.options.connect && this.connect.length && (this.index = this.find(this.options.toggle).index(r), -1 == this.index && (this.index = 0), this.connect.each(function () {
                    var e = t(this), n = e.children(), o = n.filter(".uk-active"), s = n.eq(a.index);
                    a.animating = !0, l.apply(a, [o, s]).then(function () {
                        o.removeClass("uk-active"), s.addClass("uk-active"), i.Utils.checkDisplay(s, !0), a.animating = !1
                    })
                })), this.trigger("uk.switcher.show", [r]))
            }
        }
    }), n = {
        none: function () {
            ...
            var n = ["uk-animation-slide-left", "uk-animation-slide-right"];
            return t && t.index() > i.index() && n.reverse(), e.apply(this, [n, t, i])
        }, scale: function (t, i) {
            return e.apply(this, ["uk-animation-scale-up", t, i])
        }
    }, i.switcher.animations = n, i.ready(function (e) {
    ...
    i.component("tab", {
        defaults: {
            ...
            }), i.dropdown(this.responsivetab, {mode: "click"}), e.trigger("uk.tab.change", [this.element.find(this.options.target).filter(".uk-active")]), this.check(), i.$win.on("resize orientationchange", i.Utils.debounce(function () {
            ...
            if (!(i.length < 2)) {
                ...
                if (this.responsivetab.lst.empty(), i.each(function () {
                    ...
                    }), s)for (var a = 0; a < i.length; a++)e = i.eq(a), n = e.find("a"), "none" == e.css("float") || e.attr("uk-dropdown") || (e.addClass("uk-hidden"), e.hasClass("uk-disabled") || this.responsivetab.lst.append('<li><a href="' + n.attr("href") + '" data-index="' + a + '">' + n.html() + "</a></li>"));
    ...
    i.component("tooltip", {
        defaults: {
            offset: 5, pos: "top", animation: !1, delay: 0, cls: "", src: function () {
            ...
            if (o && clearTimeout(o), s && clearTimeout(s), this.tip.length) {
                ...
                var i = this, e = t.extend({}, this.element.offset(), {
                    width: this.element[0].offsetWidth,
                    height: this.element[0].offsetHeight
                }), a = n[0].offsetWidth, r = n[0].offsetHeight, l = "function" == typeof this.options.offset ? this.options.offset.call(this.element) : this.options.offset, u = "function" == typeof this.options.pos ? this.options.pos.call(this.element) : this.options.pos, c = u.split("-"), h = {
                    display: "none",
                    visibility: "visible",
                ...
                if ("fixed" == t("html").css("position") || "fixed" == t("body").css("position")) {
                    var d = t("body").offset(), f = t("html").offset(), p = {top: f.top + d.top, left: f.left + d.left};
                    e.left -= p.left, e.top -= p.top
                }
                "left" != c[0] && "right" != c[0] || "right" != t.UIkit.langdirection || (c[0] = "left" == c[0] ? "right" : "left");
                var g = {
                    bottom: {top: e.top + e.height + l, left: e.left + e.width / 2 - a / 2},
                    top: {top: e.top - r - l, left: e.left + e.width / 2 - a / 2},
                    left: {top: e.top + e.height / 2 - r / 2, left: e.left - a - l},
                    right: {top: e.top + e.height / 2 - r / 2, left: e.left + e.width + l}
                };
                t.extend(h, g[c[0]]), 2 == c.length && (h.left = "left" == c[1] ? e.left : e.left + e.width - a);
                var m = this.checkBoundary(h.left, h.top, a, r);
                if (m) {
                    switch (m) {
                        case"x":
                            u = 2 == c.length ? c[0] + "-" + (h.left < 0 ? "left" : "right") : h.left < 0 ? "right" : "left";
                            break;
                        case"y":
                            u = 2 == c.length ? (h.top < 0 ? "bottom" : "top") + "-" + c[1] : h.top < 0 ? "bottom" : "top";
                            break;
                        case"xy":
                            u = 2 == c.length ? (h.top < 0 ? "bottom" : "top") + "-" + (h.left < 0 ? "left" : "right") : h.left < 0 ? "right" : "left"
                    }
                    c = u.split("-"), t.extend(h, g[c[0]]), 2 == c.length && (h.left = "left" == c[1] ? e.left : e.left + e.width - a)
                }
                h.left -= t("body").position().left, o = setTimeout(function () {
                    n.css(h).attr("class", ["uk-tooltip", "uk-tooltip-" + u, i.options.cls].join(" ")), i.options.animation ? n.css({
                        opacity: 0,
                        display: "block"
                    }).animate({opacity: 1}, parseInt(i.options.animation, 10) || 400) : n.show(), o = !1, s = setInterval(function () {
