...
@section('body')
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Period Types</h2>
                     <a href="{{url('admin/periodtype/create')}}" class="btn btn-sm btn-primary pull-right">Create Period Types</a> 
                        ...
                        @foreach($periodtype as $ptype)
                        	<tr>
                        		...
                        		<td style="text-align: center;">
                        			<a href="{{url('admin/periodtype/'.$ptype->id.'/edit')}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                        			<!-- <form action="{{url('admin/periodtype/'.$ptype->id)}}" method="post" id="delform">
                        			{{ method_field('DELETE') }}
                        			{{ csrf_field() }}
