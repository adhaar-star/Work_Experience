...
<html>
    <head lang="en">
        ...
        <link href="{{asset('vendors/multiselect')}}/multi.css" rel="stylesheet">
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('vendors/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.css')}}">
        ...
        <link rel="stylesheet" media="screen" type="text/css" href="{{asset('css/color-picker-layout.css')}}" />
        ...
        <script src="{{asset('vendors/multiselect')}}/multi.js"></script>
        <script async
    ...
    <body class="theme-dark menu-top menu-static colorful-enabled" ng-controller="MainCtrl">
        ...
        <section class="page-content">
            <div class="page-content-inner">
                @if(Session::has('abort_message'))
                <div class="alert alert-danger mesg">
                    <span class="glyphicon glyphicon-ok"></span>
                    <em> {!! session('abort_message') !!}</em>
                </div>
                @endif
                @section('body')
                @show
