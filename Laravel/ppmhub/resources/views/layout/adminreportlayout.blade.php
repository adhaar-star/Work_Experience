...
<html>
    <head lang="en">
        ...
        <!-- Vendors Styles -->
        <!-- v1.0.0 -->
        <link rel="stylesheet" href="{{asset('vendors/report/app.css')}}">
                   ...
                   <li class="left-menu-list-separator "> </li>-->
                    ...
                    <li class="left-menu-list-submenu">
                        ...
                        <ul class="left-menu-list list-unstyled">
                            ...
                            <li>
                                <a class="left-menu-link" href="{{url('admin/quantitative_risk/create')}}">
                                    Quantitative Risk
                                </a>
                            </li>
                            <li>
                                <a class="left-menu-link" href="{{url('admin/qualitative_risk/create')}}">
                                    Qualitative Risk
                                </a>
                            </li>
                        </ul>
					...
					<li class="left-menu-list-submenu">
                        ...
                        <ul class="left-menu-list list-unstyled">
                            <li>
							 ...
							 <li>
                               <a class="left-menu-link" href="{{url('admin/projectprocurement')}}">
