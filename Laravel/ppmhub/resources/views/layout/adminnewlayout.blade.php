...
<html>
    <head lang="en">
        ...
        <!-- Vendors Styles -->
        <!-- v1.0.0 -->
		 <link rel="stylesheet" type="text/css" href="{{asset('vendors/dashboard/style.css')}}">
        ...
        <script src="{{url('http://cdn.datatables.net/plug-ins/1.10.15/api/sum().js')}}"></script>
        <script src="{{asset('vendors/handsontable/handsontable.full.js')}}"></script>

        <script src="{{asset('vendors/editable-grid/editablegrid.js')}}"></script>
        <script src="{{asset('vendors/editable-grid/editablegrid_editors.js')}}" ></script>
        <script src="{{asset('vendors/editable-grid/editablegrid_renderers.js')}}"></script>
        <script src="{{asset('vendors/editable-grid/editablegrid_utils.js')}}" ></script>
        <script src="{{asset('vendors/editable-grid/editablegrid_validators.js')}}" ></script>
        <script src="{{asset('vendors/editable-grid/editablegrid_charts.js')}}" ></script>
        <link rel="stylesheet" href="{{asset('vendors/editable-grid/editablegrid.css')}}" type="text/css" media="screen">
                   ...
                   <li class="left-menu-list-separator "> </li>
                    ...
                    <li class="left-menu-list-submenu">
                        ...
                        <ul class="left-menu-list list-unstyled">
                            ...
                            <li> 
                                <a class="left-menu-link" href="{{url('admin/timesheetview')}}"> 
                    ...
                    <li class="left-menu-list-submenu">
                        ...
                        <ul class="left-menu-list list-unstyled">
                            ...
                            <li>
                                <a class="left-menu-link" href="{{url('admin/GlAccount')}}">
                                    Gl Account
                                </a>
                            </li>

                            <li>
                                <a class="left-menu-link" href="{{url('admin/GlAccountTax')}}">
                                    Gl Account Tax
                                </a>
                            </li>

                            <li>
                                <a class="left-menu-link" href="{{url('admin/GlAccountFreight')}}">
                                    Gl Account Freight
                                </a>
                            </li>

                            <li>
                                <a class="left-menu-link" href="{{url('admin/GlAccountDownPayment')}}">
                            ...
                            <li>
                                <a class="left-menu-link" href="{{url('admin/costcentretype')}}">
                                    Cost Centre
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="left-menu-link" href="{{url('admin/activityrates')}}">
                                    Activity Rates 
                                </a>
                            </li>
                            <li>
