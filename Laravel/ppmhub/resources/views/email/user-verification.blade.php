...
<div class="invoice-box">
    <div class="header">
        <img src="{{url('/vendors/common/img/ppm_logo.png')}}" style="width:100%; max-width:220px;">
    ...
    <div class="content">
         <table>
            <tr>
                <td>Please click on the invitation link below to join PPMHub: </td>
                <td><a href="{{url('/verify/'.$user_details->id.'/'.$user_details->remember_token)}}">Join PPMHub</a></td>
            </tr>
        </table>
