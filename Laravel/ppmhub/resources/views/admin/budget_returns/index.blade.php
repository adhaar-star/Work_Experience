...
@section('title','Budget | Return Budget')
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Are you sure you want to delete this return budget?</p>
                    </div>
                ...
                <div class="dashboard-buttons">
                    ...
                    <a href="javascript:void(0)" class="btn btn-default" style="cursor:no-drop; color:#97A7A7;">
                        ...
                        <a href="javascript:void(0)" class="btn btn-default" style="cursor:no-drop; color:#97A7A7;">
                            ...
                            <a href="javascript:void(0)" class="btn btn-default" style="cursor:no-drop; color:#97A7A7;">
                                @else
                                <a href="{{url('admin/returnbudget')}}" class="btn btn-primary margin-left-10 active">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="action-btn">
                                                        ...
                                                        <a href="javascript:void(0)" class="btn btn-default btn-xs margin-right-1" style="cursor:no-drop; color:#97A7A7;">
                                                            ...
                                                            <a href="javascript:void(0)" class="btn btn-default btn-xs margin-right-1" style="cursor:no-drop; color:#97A7A7;">
                                                                @else
                                                                <a href="{{url('admin/projectbudget/returns/edit/'.$budget->id)}}" class="btn btn-info btn-xs margin-right-1">@endif<i class="fa fa-pencil"></i> <!--Edit--> </a>                                                                               
                                                                @if (RoleAuthHelper::hasAccess('budget.delete')!=true)  
                                                                <a href="javascript:void(0)" class="btn btn-default btn-xs margin-right-1" style="cursor:no-drop; color:#97A7A7;">
                                                                    @else
                                                                    <a href="javascript:void(0)" class="btn btn-danger btn-xs deleteReturn" data-id="{{$budget->id}}">@endif<i class="fa fa-trash-o"></i> <!--Delete--> </a>
                                                                    <!-- MODAL-->
                                                                    <div class="modal fade table-view-popup" id="table-view-popup_{{$budget->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                                        <div class="modal-dialog" role="document" style="text-align:left;">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-footer"> 
                                                                                    <span class="edit-btn"><a href="{{url('admin/projectbudget/returns/edit/'.$budget->id)}}" class="btn btn-primary">Edit</a></span>
                                                                    ...
                                                                    <script>
                                                                      ...
                                                                      $(document).on("click", ".delete", function () {
                                                                          ...
                                                                          $.ajax({
                                                                              type: 'POST',
                                                                              url: '/admin/projectbudget/returns/delete/' + id,
                                                                              data: {
                                                                                  '_token': token
                                                                              },
                                                                              dataType: "JSON",
