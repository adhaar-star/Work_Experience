...
@section('title','Create Activity Rate')
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form id="project" method="post" action="{{url('admin/activityrate_save')}}" data-parsley-validate="" class="form-horizontal form-label-left" novalidate>
                            {!! csrf_field() !!}
                            ...
                            <div class="margin-bottom-50 form-width">
                                ...
                                <div class="margin-bottom-50">
                                    ...
                                    <ul class="list-unstyled breadcrumb breadcrumb-custom">
                                        ...
                                        <li>
                                            <span>Create Activity Rate</span>
                                        </li>
                                ...
                                <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-8">
                                                <div class="form-input-icon">
                                                    <select class="form-control" id="7" name="cost_centre_id">
                                                        ...
                                                        {
                                                        <option value="{{$cost->cost_id}}">{{$cost->cost_centre}}
                                                        </option>
                                                        }
                                                        @endforeach       
                                                    </select>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group form-margin-btm">
                                            ...
                                            <div class="col-xs-12 col-sm-8">
                                                <div class="form-input-icon">
                                                    <input class="form-control" placeholder="Actual Rate" id="activity_actual_rate" name="activity_actual_rate" type="text">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group form-margin-btm">
                                            ...
                                            <div class="col-xs-12 col-sm-8">
                                                <div class="form-input-icon">
                                                    {!!Form::text('billing_rate','',array('class'=>'form-control','placeholder'=>'Billing Rate'))!!}  
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group form-margin-btm">
                                            ...
                                            <div class="col-xs-12 col-sm-8">
                                                <div class="form-input-icon">
                                                    <input class="form-control" placeholder="Plan Rate" id="activity_plan_rate" name="activity_plan_rate" type="text">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group form-margin-btm">
                                            ...
                                            <div class="col-xs-12 col-sm-8">
                                                <div class="form-input-icon">
                                                    <textarea class="form-control" style="resize:none" rows="3" id="l15" name="activity_rate_description" placeholder="Activity Rate Description..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-xs-12 col-sm-8">
                                                <div class="form-input-icon">
                                                    <div class='input-group date' id='datetimepicker1'>
                                                        <input placeholder="Pick your start date" id="start-date" name="activity_validity_start" type="text" class="form-control datepicker-init">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group form-margin-btm">
                                            ...
                                            <div class="col-xs-12 col-sm-8">
                                                <div class="form-input-icon">
                                                    <div class='input-group date' id='datetimepicker1'>
                                                        <input placeholder="Pick your end date" id="end-date" name="activity_validity_end" type="text" class="form-control datepicker-init">
                                                        <span class="input-group-addon"> <i class="icmn-calendar"></i> </span> </span> </div>
                                                </div>
                                            </div>
                                        </div>
