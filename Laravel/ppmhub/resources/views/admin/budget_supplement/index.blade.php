...
@section('title','Budget | Supplement Budget')
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Are you sure you want to delete this supplement budget?</p>
                    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="dashboard-buttons">
                    ...
                    <a href="javascript:void(0)" class="btn btn-default" style="cursor:no-drop; color:#97A7A7;">
                        ...
                        <a href="javascript:void(0)" class="btn btn-default" style="cursor:no-drop; color:#97A7A7;">
                            @else
                            <a href="{{url('admin/supplementbudget')}}" class="btn btn-primary margin-left-10 active">
                                @endif
                                <i class="fa fa-send margin-right-5"></i>
                                Supplement Budget
                            </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="action-btn">
                                                        ...
                                                        <a href="javascript:void(0)" class="btn btn-default btn-xs margin-right-1" style="cursor:no-drop; color:#97A7A7;">
                                                            ...
                                                            <a href="javascript:void(0)" class="btn btn-default btn-xs margin-right-1" style="cursor:no-drop; color:#97A7A7;">
                                                                @else
                                                                <a href="{{url('admin/projectbudget/supplement/edit/'.$budget->id)}}" class="btn btn-info btn-xs margin-right-1">@endif<i class="fa fa-pencil"></i> <!--Edit--> </a>
                                                                @if (RoleAuthHelper::hasAccess('budget.delete')!=true)  
                                                                <a href="javascript:void(0)" class="btn btn-default btn-xs margin-right-1" style="cursor:no-drop; color:#97A7A7;">
                                                                    @else
                                                                    <a href="javascript:void(0)" class="btn btn-danger btn-xs deleteSupplement" data-id="{{$budget->id}}">@endif<i class="fa fa-trash-o"></i> <!--Delete--> </a>
                                                                    <div class="modal fade table-view-popup" id="table-view-popup_{{$budget->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                                        <div class="modal-dialog" role="document" style="text-align:left;">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    ...
                                                                                    <div class="margin-bottom-10">
                                                                                        <ul class="list-unstyled breadcrumb">
                                                                                            ...
                                                                                            <li>
                                                                                                <a href="javascript: void(0);">Supplement Budget</a>
                                                                                            </li>
                                                                                            <li>
                                                                                ...
                                                                                <div class="modal-footer"> 
                                                                                    <span class="edit-btn"><a href="{{url('admin/projectbudget/supplement/edit/'.$budget->id)}}" class="btn btn-primary">Edit</a></span>
                                                                    ...
                                                                    <script>
                                                                      var id = "";
                                                                      $(document).on("click", ".deleteSupplement", function () {
                                                                          $('#myModal').modal('show');
                                                                      ...
                                                                      $(document).on("click", ".delete", function () {
                                                                          ...
                                                                          $.ajax({
                                                                              type: 'POST',
                                                                              url: '/admin/projectbudget/supplement/delete/' + id,
                                                                              data: {
                                                                                  '_token': token
                                                                              },
                                                                              dataType: "JSON",
