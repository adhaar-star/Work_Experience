...
@section('title','Settings | Quotation Number Range')
@section('body')
@if (count($errors) > 0)
            ...
            <div class="col-lg-12">
                ...
                <div class="margin-bottom-50">
                    ...
                    <ul class="list-unstyled breadcrumb breadcrumb-custom">
                        ...
                        <li>
                            <span>Quotation Number Range</span>
                        </li>
                        <li>
                            <span>Edit Quotation Number Range</span>
                        </li>
                    </ul>
                </div>
                <h4>Edit Quotation Number Range</h4>
                <div class="row">
                    <div class="col-md-12">
                        <div class="margin-bottom-50 margin-top-25">
                            <table class="tableizer-table table table-bordered text-center" border="1" style="width: 60%;">
                                ...
                                <tbody> 
                                    {!! Form::open(array('route'=>array('quotationNumber.update',$quotationNumber_range->id),'method' => 'put','id'=>'quotatioNnumber')) !!}
                                    <tr id="editquotation_{{$quotationNumber_range->id}}" class="range">
                                        <td class="startrange">
                                            {!!Form::text('start_range',$quotationNumber_range->start_range,array('class'=>'form-control border-radius-0 startrange','id'=>'startrange'))!!}
                                        </td>
                                        <td class="endrange">
                                            {!!Form::text('end_range',$quotationNumber_range->end_range,array('class'=>'form-control border-radius-0 endrange','id'=>'endrange'))!!}
                                        </td>
                                        <td> 
