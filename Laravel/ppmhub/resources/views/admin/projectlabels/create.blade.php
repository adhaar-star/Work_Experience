...
@section('title','Create Issue Label')
@section('body')
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                ?>
                    ...
                    <form id="Projectphaseform" method="post" action="{{url('admin/projectlabels/create')}}" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                  {{ csrf_field() }}
                                        <div class="margin-bottom-50">
                       ...
                       <input placeholder="Name" id="label_name" name="label_name" value="{{old('label_name')}}" class="form-control border-radius-0" type="text">							
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                <div class="form-input-icon">
                                                    ...
                                                    <input placeholder="#000" id="label_color" name="label_color" value="{{old('label_color')}}" required="required" class="form-control border-radius-0" type="hidden">
                                                </div>
                                            </div>
                                        </div>
