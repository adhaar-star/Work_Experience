        ...
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="row PageTitleGlobal margin-bottom-50">
                        ...
                        <div class="col-md-9 text-right">
                            ...
                            <ul class="list-unstyled breadcrumb breadcrumb-custom">
                                ...
                                <li><a href="{{url('admin/projectscheduling')}}">Project dashboard</a></li>
                                <li><span>
                ...
                <div class="card">
                  ...
                  @endif
                  <a href="{{url('admin/projectscheduling')}}"><button type="button" class="btn btn-danger">Cancel</button></a>
               </div>                     
               </form>
            </div>
         </div>
