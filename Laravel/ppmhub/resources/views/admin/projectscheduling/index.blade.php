        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="row PageTitleGlobal margin-bottom-40">
                    <div class="col-md-3">
                        <h1>Project</h1>
                        @if (RoleAuthHelper::hasAccess('projectscheduling.create')!=true)  
                                ...
                                <tr>    
                                    ...
                                    <td class="action-btn">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-default btn-xs margin-right-1" style="cursor:no-drop; color:#97A7A7;">
                                            @else
                                            <a href="#" data-toggle="modal" data-target="#table-view-popup_{{$proj->id }}">@endif<i class="fa fa-eye" aria-hidden="true"></i> view </a>
                                            @if (RoleAuthHelper::hasAccess('projectscheduling.update')!=true)  
                                            <a href="javascript:void(0)" class="btn btn-default btn-xs margin-right-1" style="cursor:no-drop; color:#97A7A7;">
                                                @else
                                                <a href="{{url('admin/project/'.$proj->id.'/edit')}}">@endif<i class="fa fa-pencil"></i> Edit </a>
                                                        ...
                                                        <div class="modal-dialog" role="document" style="text-align:left;">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    ...
                                                                    <div class="margin-bottom-10">
                                                                        <ul class="list-unstyled breadcrumb">
                                                                            ...
                                                                            <li>
                                                                                <a href="{{url('admin/project')}}">Project Dashboard</a>
                                                                            </li>
                                                                            <li>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <span class="edit-btn"><a href="{{url('admin/projectscheduling/'.$proj->id.'/edit')}}" class="btn btn-primary">Edit</a></span>
