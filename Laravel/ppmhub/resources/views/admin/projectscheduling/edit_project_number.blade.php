...
@section('title','Settings | Project Number Range')
@section('body')
@if (count($errors) > 0)
            ...
            <div class="col-lg-12">
                ...
                <div class="margin-bottom-50">
                    ...
                    <ul class="list-unstyled breadcrumb breadcrumb-custom">
                        ...
                        <li>
                            <a href="/admin/project_number_range"> Project Number Range </a>
                        </li>
                        <li>
                            <span>Edit Project Number Range</span>
                        </li>
                    </ul>
                </div>
                <h4>Edit Project Number Range</h4>
                <div class="row">
                    <div class="col-md-12">
                        <div class="margin-bottom-50 margin-top-25">
                            <table class="tableizer-table table table-bordered text-center" border="1" style="width: 60%;">
                                ...
                                <tbody> 
                                    {!! Form::open(array('route'=>array('projectNumber.update',$number_range->id),'method' => 'put','id'=>'inquirynumber')) !!}
