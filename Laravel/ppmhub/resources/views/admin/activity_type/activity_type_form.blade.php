            ...
            <div class="panel-body bg-lightcyan">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form id="project" method="post" action="{{url('admin/activitytype_save')}}" data-parsley-validate="" class="form-horizontal form-label-left" novalidate>
                            {!! csrf_field() !!}
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-2">
                                                        <div class="form-input-icon">
                                                            <input class="form-control border-radius-0 " placeholder="Activity Type" id="activity_type" name="activity_type" type="text" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-2">
                                                        <div class="form-input-icon">
                                                            <textarea class="form-control border-radius-0 " rows="3" id="l15" style="resize:none" name="activity_description" placeholder="Activity Description..."></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-2">
                                                        <div class="form-input-icon">
                                                            <input class="form-control border-radius-0 " placeholder="Cost Element" id="cost_element" name="cost_element" type="text">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-3">
                                                        <div class="form-input-icon">
                                                            <textarea class="form-control border-radius-0 " style="resize:none" rows="3" id="l15" name="cost_element_description" placeholder="Cost Element Description..."></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="btn-group" data-toggle="buttons">
                                                    ...
                                                    <a class="active-bttn btn btn-default">
