    ...
    <div class="panel-body bg-lightcyan">
        <div class="row">
            <div class="col-lg-12">
                ...
                @endif
                <form id="planningunit" method="post" action="<?php
                if (isset($planningunit) && $planningunit->id) {
                    echo url('admin/planningunit/' . $planningunit->id);
                } else {
                    echo url('admin/planningunit');
                }
                    ...
                    <div class="margin-bottom-50">
                        <div class="margin-bottom-50">
                            ...
                            <ul class="list-unstyled breadcrumb breadcrumb-custom">
                                ...
                                <li>
                                    <a href="{{url('admin/planningunit')}}">Planning Unit</a>
                                </li>
                                <li>
                                    <span>
                                        @if(isset($planningunit) && $planningunit->id)
                        ...
                        <div class="card">
                            ...
                            <div class="card-block bg-lightcyan">
                                <div class="row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-12 col-sm-2">
                                                <div class="form-input-icon">
                                                    ...
                                                    if (isset($planningunit)) {
                                                        echo $planningunit->name;
                                                    }
                                    ...
                                    <?php
                                    if (isset($planningunit->created_at) && (!empty($planningunit->created_at))) {
                                            ...
                                            <div class="col-xs-12 col-sm-2">										
                                                <div class="btn-group" data-toggle="buttons">
                                                    <a class="active-bttn btn btn-primary active">
                                                        ...
                                                        if (isset($planningunit) && $planningunit->status == 'active') {
                                                            echo "checked";
                                                        }
                                                        ?>>
                                                        Active
                                                    ...
                                                    <a class="inactive-btn btn btn-danger">
                                                        ...
                                                        if (isset($planningunit) && $planningunit->status == 'inactive') {
                                                            echo "checked";
                                                        }
                                                        ?>>
                                                        Inactive
                            ...
                            <div class="card-footer card-footer-box">
                                ...
                                <a href="{{url('admin/planningunit')}}"><button type="button" class="btn btn-danger">Cancel</button></a>
                            </div>                     
