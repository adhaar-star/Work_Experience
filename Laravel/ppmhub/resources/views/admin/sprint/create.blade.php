...
@section('title','Create Sprint | Agile Methodology')
@section('body')
            ...
            <div class="col-lg-12">
                ...
                <div class="margin-bottom-50">
                    ...
                    <ul class="list-unstyled breadcrumb breadcrumb-custom">
                        ...
                        <li>
                            <span>Create Project Labels</span>
                        </li>
                    </ul>
                </div>
                ...
                ?>
                    ...
                    <form id="Projectphaseform" method="post" action="{{url('admin/sprint/create')}}" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                  {{ csrf_field() }}
                                        <div class="margin-bottom-50">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                <div class="form-input-icon">
                                                     ...
                                                     {!!Form::text('sprint_number',isset($sprint_count_number) ? $sprint_count_number : '1',array('class'=>'sprint_number form-control border-radius-0','readonly'))!!}
                                                </div>
                                            </div>
                                        </div>
                                           ...
                                           <div class="form-group row">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                <div class="form-input-icon">
                                                    ...
                                                    {!!Form::text('sprint_period','' ,array('class'=>'sprint_number form-control border-radius-0','id' => 'duration_select'))!!} <span style="float: right; position: absolute; right: -50px; margin-top: -24px;">Weeks</span>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                                <div class="form-input-icon">
                                                    <label class="input-group datepicker-only-init">
                                                        <input type="text" placeholder="Sprint Start date" id="a_start_date" name="start_date" value="{{date('Y-m-d')}}" required="required" class="form-control border-radius-0 datepicker-only-init a_start">
...
?>
                                                        <input type="text" placeholder="Sprint End date" id="a_end_date" name="end_date" value="{{$endDate}}" required="required" class="form-control border-radius-0 datepicker-only-init a_start">
                                                         <span class="input-group-addon border-radius-0"> <i class="icmn-calendar"></i> </span>
                                                    </label>
