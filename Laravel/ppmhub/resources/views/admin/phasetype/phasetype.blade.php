...
@section('title','Settings | Phase Type')
@section('body')
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="dashboard-buttons">
                    @if (RoleAuthHelper::hasAccess('phaseType.create')!=true)  
                    <a href="javascript:void(0)" class="btn btn-default" style="cursor:no-drop; color:#97A7A7;">
                        @else
                        <a href="{{url('admin/phasetype/create')}}" class="btn btn-primary">
                            @endif
                        ...
                        <table class="table table-inverse" id="example3" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="action-btn">
                                        @if (RoleAuthHelper::hasAccess('phaseType.update')!=true)  
                                        <a href="javascript:void(0)" class="btn btn-default btn-xs margin-right-1" style="cursor:no-drop; color:#97A7A7;">
                                            @else
                                            <a href="{{url('admin/phasetype/'.$type->id.'/edit')}}" class="btn btn-info btn-xs margin-right-1">@endif<i class="fa fa-pencil"></i> </a>

                                            {!! Form::open(array('route' => array('phaseType.delete',$type->id), 'method' => 'DELETE','id'=>'delform'.$type->id)) !!}
                                            @if (RoleAuthHelper::hasAccess('phaseType.delete')!=true)  
                                            <a href="javascript:void(0)" class="btn btn-default btn-xs margin-right-1" style="cursor:no-drop; color:#97A7A7;">
                                                @else
                                                <a href="javascript:void(0)" onclick="var res = confirm('Are you sure you want to delete this phase type');
                                                      if (res) {
