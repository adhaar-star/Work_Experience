...
@section('title','Report | Invoice Verification For A Project Report')
@section('body')
{!! Html::script('/js/invoice_report.js') !!}
        ...
        <div class="row">
            <div class="col-lg-12">			
                ...
                <div class="margin-bottom-50 box_h2">
                    ...
                    <div class="col-xl-7">
                        <h3>Project Report: Invoice Verification For A Purchase order</h3>
                    </div>	
                            ...
                            <div class="margin-bottom-50">
                                <div class="card form_box">
                                    ...
                                    <div class="card-block">
                                        <div class="row" >
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                ...
                                                <div class="col-md-12">
                                                    <!--                                                    <div>	
                                                                                                            {!!Form::select('invoicereportpurchaseorder',$purchaseOrder,'',array('class'=>'form-control select2','multiple'=>true))!!}
                                                                                                        </div>-->
                                                    <div>	
                                                        {!!Form::select('invoicereportpurchaseorder',$purchaseOrder,'',array('class'=>'form-control select2 border-radius-0','placeholder'=>'Please select Purchase Order no'))!!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer card-footer-box text-right">
                                        ...
                                        <a href="{{url('admin/invoiceverificationreport')}}"><button type="button" class="btn btn-danger">Cancel</button></a>
                                    </div>                     
                                </div>
                            </div>
                                ...
                                <table class="table table-inverse table-responsive" id="DateTablePPMHUB" width="100%">
                                    <thead>
                                        <tr class="report_theam">
                                            ...
                                            <th>GR/IR</th>
                                            <th>GR/IR Amount</th>
                                            <th>GR/IR Dr/Cr Indicator </th>	
                                            <th>G/L Account</th>
                                            <th>Dr/Cr Indicator</th>
                                            <th>Accounts Payable Amount</th>							
                                        </tr>
                                    </thead>
                                    <tbody> </tbody>
                                </table>
