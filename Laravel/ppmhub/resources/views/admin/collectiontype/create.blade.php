    ...
    <div class="panel-body bg-lightcyan">
        <div class="row">
            <div class="col-lg-12">
                ...
                <form id="collectiontype" method="post" action="<?php
                if (isset($collectiontype) && $collectiontype->id) {
                    echo url('admin/collectiontype/' . $collectiontype->id);
                } else {
                    echo url('admin/collectiontype');
                }
                    ...
                    <div class="margin-bottom-50">
                        <div class="margin-bottom-50">
                            ...
                            <ul class="list-unstyled breadcrumb breadcrumb-custom">
                                ...
                                <li>
                                    <a href="{{url('admin/collectiontype')}}">Collection Type</a>
                                </li>
                                <li>
                                    <span>
                                        @if(isset($collectiontype) && $collectiontype->id)
                        ...
                        <div class="card">
                            ...
                            <div class="card-block bg-lightcyan">
                                <div class="row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-12 col-sm-2">
                                                <div class="form-input-icon">
                                                    ...
                                                    if (isset($collectiontype)) {
                                                        echo $collectiontype->description;
                                                    }
                                                    ?>" required="required" class="form-control border-radius-0">
                                                </div>
                                            </div>
                                    ...
                                    <?php
                                    if (isset($collectiontype->created_at) && (!empty($collectiontype->created_at))) {
                                            ...
                                            <div class="col-xs-12 col-sm-2">
                                                <div class="btn-group" data-toggle="buttons">
                                                    <a class="active-bttn btn btn-default active">
                                                        ...
                                                        if (isset($collectiontype) && $collectiontype->status == 'active') {
                                                            echo "checked";
                                                        }
                                                        ?>>
                                                        Active
                                                    ...
                                                    <a class="inactive-btn btn btn-default">
                                                        ...
                                                        if (isset($collectiontype) && $collectiontype->status == 'inactive') {
                                                            echo "checked";
                                                        }
                                                        ?>>
                                                        Inactive
                            ...
                            <div class="card-footer card-footer-box">
                                ...
                                <a href="{{url('admin/collectiontype')}}"><button type="button" class="btn btn-danger">Cancel</button></a>	
                            </div>                     
