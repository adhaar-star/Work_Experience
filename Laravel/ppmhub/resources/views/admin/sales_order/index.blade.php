        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="dashboard-buttons">
                    @if (RoleAuthHelper::hasAccess('salesorder.create')!=true)  
                                ...
                                <div class="margin-bottom-50">
                                    <table class="table table-inverse" id="example3" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    @if (RoleAuthHelper::hasAccess('salesorder.view')!=true)  
                                                    {{$sales->salesorder_number}}
                                                    @else
                                                    <a data-toggle="modal" data-target="#table-view-popup_{{$sales->id}}">
                                                        {{$sales->salesorder_number}}
                                                        @endif
                                                    </a>
                                                </td>
                                                ...
                                                <td class="action-btn">
                                                    ...
                                                    <a href="javascript:void(0)" class="btn btn-default btn-xs margin-right-1" style="cursor:no-drop; color:#97A7A7;">
                                                        @else
                                                        <a href="#" class="btn btn-info btn-xs margin-right-1" data-toggle="modal" data-target="#table-view-popup_{{$sales->id }}">@endif<i class="fa fa-eye" aria-hidden="true"></i> <!--view--> </a>
                                                        @if (RoleAuthHelper::hasAccess('salesorder.update')!=true)  
                                                        <a href="javascript:void(0)" class="btn btn-default btn-xs margin-right-1" style="cursor:no-drop; color:#97A7A7;">
                                                            @else
                                                            <a href="{{url('admin/sales_order/'.$sales->id.'/edit')}}" class="btn btn-info btn-xs margin-right-1">@endif<i class="fa fa-pencil"></i> <!--Edit--> </a>

                                                            {!! Form::open(array('route' => array('salesorder.delete',$sales->id), 'method' => 'DELETE','id'=>'delform'.$sales->id)) !!}
                                                            @if (RoleAuthHelper::hasAccess('salesorder.delete')!=true)  
                                                            <a href="javascript:void(0)" class="btn btn-default btn-xs margin-right-1" style="cursor:no-drop; color:#97A7A7;">
                                                                @else
