{!! Form::open(['url' =>route('sales-order-inquiry-save-item', $order->sales_inquiry_id),   'class' => 'form-horizontal  GlobalFormValidation SO_ManageItems']) !!}
@if(!empty($updateItem))
    {!! Form::hidden('sales_inquiry_item_id', $updateItem->sales_inquiry_item_id ) !!}
@endif
<div class="row">
    <div class="col-sm-6">
...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        @endif
        <a href="{{ route('sales-order-inquiry-items', $order->sales_inquiry_id) }}" class="btn btn-danger">Cancel</a>
    </div>
</div>
{!! Form::close() !!}