...
<section id="create_form" class="panel">
    <div class="panel-body">
        {!! Form::open(['url' => route('sales-order-update', $order->sales_order_id),  'class' => 'form-horizontal GlobalFormValidation']) !!}
        <div class="row">
            <div class="col-lg-12">

                 <div class="margin-bottom-50">
                    <ul class="list-unstyled breadcrumb breadcrumb-custom">
                        <li>You are here : <a href="javascript: void(0);" style="margin-left: 10px;">Sales Order</a></li>
                        <li><a href="{{  route('sales-order-index') }}">Sales Order</a></li>
                        <li><span>Edit Sales Order</span></li>
                    </ul>
                </div>

                <div class="card">
                    <div class="card-header card-header-box bg-lightcyan">
                        <h4 class="margin-0">Update Sales Order</h4>
                    </div>
                        ...
                        <div class="tab-content">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                            <div class="form-input-icon">
                                                {!!Form::text('sales_order_no', $order->sales_order_no, [ 'class'=>'form-control border-radius-0', 'readonly' ] )!!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                            <div class="form-input-icon">
                                                {!!Form::select('customer', $customers, $order->customer,
                                                [
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                            {!!Form::number('down_payment',  $order->down_payment, [
                                                'class'=>'form-control border-radius-0',
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                            {!!Form::select('quotation', $quotations, $order->quotation, ['class'=>'form-control border-radius-0 select2','placeholder'=>'Please select quotation number','id'=>'quotation_no'] )!!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                            {!!Form::select('inquiry',  $inquiries, $order->inquiry , ['class'=>'form-control border-radius-0 select2','placeholder'=>'Please select inquiry number','id'=>'inquiry_no'] )!!}
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                            <div class="form-input-icon">
                                                {!!Form::textarea('description', $order->description , ['class'=>'form-control header_note  border-radius-0 no-resize','placeholder'=>'Please enter sales order detailed description','maxlength'=>255, 'rows'=>3 ] )!!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                            {!!Form::select('region', $regions, $order->region, [ 'class' => 'form-control border-radius-0 select2', 'placeholder'=> 'Please select sales region', 'id'=>'sales_region' ]   ) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                            {!!Form::select('organization', $organizations, $order->organization , [ 'class'=>'form-control border-radius-0 select2','placeholder'=>'Please select sales organization','id'=>'sales_organization']  )!!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                            {!!Form::select('requested_by', $employees, $order->requested_by , [ 'class'=>'form-control border-radius-0 select2','placeholder'=>'Please select requested by','id'=>'requested_by' ] )!!}
                                        </div>
                                    </div>
                            ...
                            <div class="row afterOnChangeOrderType">
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                            <div class="form-input-icon">
                                                {!!Form::number('total_recurring_period', $order->total_recurring_period , [
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                            <div class="form-input-icon">
                                                {!!Form::text('auto_billing_date',   $order->auto_billing_date , [
                                        ...
                                        <div class="col-md-12 col-md-offset-2">
                                            <div class="form-input-icon">
                                                <label class="containerCheckbox"> Auto Billing
                                                    {!! Form::checkbox('auto_billing', 1, $order->auto_billing) !!}
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-xs-12 col-sm-6 col-md-4 col-form-label">Approver 1*:</label>
                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                            <div class="form-input-icon">
                                                {!!Form::select('approver_1', $employees,
                                                $order->approver_1, ['class'=>'form-control border-radius-0 select2','placeholder'=>'Please select Approver 1',
                                                'data-fv-notempty' => true,
                                                'data-fv-blank' => true,
                                                'data-rule-required' => true,
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                            <div class="form-input-icon">
                                                ...
                                                $order->approver_2 , ['class'=>'form-control border-radius-0 select2','placeholder'=>'Please select Approver 2'
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                            <div class="form-input-icon">
                                                {!!Form::select('approver_3', $employees,
                                                  $order->approver_3  , ['class'=>'form-control border-radius-0 select2','placeholder'=>'Please select Approver 3'
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                            <div class="form-input-icon">
                                                {!!Form::select('approver_4', $employees,
                                                  $order->approver_4  , ['class'=>'form-control border-radius-0 select2','placeholder'=>'Please select Approver 4'
        ...
        <div class="card-footer card-footer-box">
            ...
            {!! Form::submit('Update Order',array('class'=>'btn btn-primary card-btn','id'=>'btn_save')) !!}
