...
@section('title','Settings | Category | Create Category')
@section('body')
@if (count($errors) > 0)
                    ...
                    <div class="col-md-12">
                        <div class="margin-bottom-50 margin-top-25">
                            <table class="tableizer-table table table-bordered text-center" border="1" style="width: 40%;">
                                ...
                                <tbody> 
                                    {!! Form::open(array('route'=>array('category.create'),'method' => 'post','id'=>'category')) !!}
                                    <tr id="editInquiry" class="range">
                                        <td class="startrange">
                                            {!!Form::text('category_name','',array('class'=>'form-control border-radius-0 category_name','id'=>'category_name'))!!}
                                        </td>
                                        <td> 
                                            {!! Form::submit('Create',array('class'=>'btn btn-primary card-btn save')) !!}  
                                        </td>
                                    </tr>
                                    {!!Form::close()!!}
                                </tbody>
