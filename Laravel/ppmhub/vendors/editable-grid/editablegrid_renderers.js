...
function EnumCellRenderer(config) {
    this.init(config);
}
...
function NumberCellRenderer(config) {
    this.init(config);
}
...
NumberCellRenderer.prototype.render = function (element, value)
{
    ...
    element.innerHTML = (displayValue=='NaN')?'':displayValue;
    if (!isNAN)
...
function CheckboxCellRenderer(config) {
    this.init(config);
}
...
function EmailCellRenderer(config) {
    this.init(config);
}
...
function WebsiteCellRenderer(config) {
    this.init(config);
}
...
function DateCellRenderer(config) {
    this.init(config);
}
