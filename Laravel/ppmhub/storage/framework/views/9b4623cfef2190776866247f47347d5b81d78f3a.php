        ...
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="row PageTitleGlobal margin-bottom-50">
                        ...
                        <div class="col-md-9 text-right">
                            ...
                            <ul class="list-unstyled breadcrumb breadcrumb-custom">
                                ...
                                <li><a href="<?php echo e(url('admin/project')); ?>">Project dashboard</a></li>
                                <li><span>
                                        <?php if(isset($project) && $project->id): ?>
                                        Edit
                                        <?php else: ?>
                ...
                <div class="card">
                  ...
                  <?php endif; ?>
                  <a href="<?php echo e(url('admin/project')); ?>"><button type="button" class="btn btn-danger">Cancel</button></a>
               </div>                     
               </form>
            </div>
         </div>
