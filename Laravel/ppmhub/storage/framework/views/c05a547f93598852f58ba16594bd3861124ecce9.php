<?php if (isset($buckets) && $buckets->id) { ?>
  <?php $__env->startSection('title','Edit Bucket'); ?>
<?php } else { ?>
  <?php $__env->startSection('title','Create Bucket'); ?>
<?php } ?>
...
<?php echo Html::script('/js/bucket.js'); ?>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-lg-12">
                <div class="togle-btn pull-right">
                    <div class="dropdown inner-drpdwn">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="" role="menu">
                            ...
                            <a class="dropdown-item" href="<?php echo e(url('admin/portfolioresourceplanning')); ?>">Portfolio Resource Planning</a>
                ...
                <?php if (isset($buckets) && $buckets->id) {
                  ?>
                  <?php echo Form::model($buckets, array('class' => '', 'id' => 'bucketstypeform', 'method' => 'PATCH', 'route' => array('buckets.update', $buckets->id))); ?>

                <?php } else { ?>
                  <?php echo Form::open(array('route' => 'buckets.create', 'method' => 'POST','id' => 'bucketstypeform', 'class' => '')); ?> 
                <?php }
                ?>
                ...
                <div class="margin-bottom-50">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                        <?php if (isset($buckets)) { ?>
                                          <?php echo Form::select('portfolio_id',$portfolio, old('portfolio_id', $buckets->portfolio_id), array('class'=>'select2 selectRequired','id'=>'portfolio_id','placeholder'=>'Please select portfolio')); ?>

                                        <?php } else { ?>
                                          <?php echo Form::select('portfolio_id',$portfolio, old('portfolio_id'), array('class'=>'select2 selectRequired','id'=>'portfolio_id','placeholder'=>'Please select portfolio')); ?>	
                                        <?php } ?>
                                        <?php if($errors->has('portfolio_id')): ?> 
                                        <div style='color:red'>
                                            <?php echo e($errors->first('portfolio_id')); ?>
                        ...
                        <div class="row" style="margin: 0;">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                        <?php if (isset($buckets)) { ?>
                                          <?php echo Form::select('costcentretype',$costcentretype, old('costcentretype', $buckets->costcentretype), array('class'=>'select2 border-radius-0 selectRequired', 'id'=>'costcentretype','placeholder'=>'Please select cost center')); ?>

                                        <?php } else { ?>
                                          <?php echo Form::select('costcentretype',$costcentretype, old('costcentretype'), array('class'=>'select2 border-radius-0 selectRequired', 'id'=>'costcentretype','placeholder'=>'Please select cost center')); ?>	
                                        <?php } ?>

                                        <?php if($errors->has('costcentretype')): ?> 
                                        <div style='color:red'>
                                            <?php echo e($errors->first('costcentretype')); ?>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                        <?php if (isset($buckets)) { ?>
                                          <?php echo Form::select('department',$department, old('department', $buckets->department), array('class'=>'select2 border-radius-0 selectRequired','id'=>'department','placeholder'=>'Please select department')); ?>

                                        <?php } else { ?>
                                          <?php echo Form::select('department',$department, old('department'), array('class'=>'select2 border-radius-0 selectRequired','id'=>'department','placeholder'=>'Please select department')); ?>	
                                        <?php } ?>
                        ...
                        <div class="row" style="margin: 0;">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                        <?php if (isset($buckets)) { ?>
                                          <?php echo Form::select('currency', $currency, old('currency',$buckets->currency), array('class'=>'select2 selectRequired','id'=>'currency','placeholder'=>'Please select currency')); ?>

                                        <?php } else { ?>
                                          <?php echo Form::select('currency', $currency, old('currency'), array('class'=>'select2 selectRequired','id'=>'currency','placeholder'=>'Please select currency')); ?>	
                                        <?php } ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                                        <div class="btn-group" data-toggle="buttons">
                                            <?php if(!isset($buckets->status)): ?>
                                            <a class="active-bttn btn btn-primary active">
                                                <?php echo Form::radio('status','active','active'); ?>Active
                                            </a>
                                            <a class="inactive-btn btn btn-danger">
                                                <?php echo Form::radio('status','inactive'); ?>Inactive
                                            </a>
                                            <?php else: ?>
                                            <?php if($buckets->status == 'active'): ?>
                                            <a class="active-bttn btn btn-primary active">
                                                <?php echo Form::radio('status','active'); ?>Active
                                            </a>
                                            <a class="inactive-btn btn btn-danger">  <?php echo Form::radio('status','inactive'); ?>Inactive</a>
                                            <?php else: ?>
                                            <a class="active-bttn btn btn-primary"> <?php echo Form::radio('status','active'); ?>Active</a>
                    ...
                    <div class="card-footer card-footer-box text-right">
                        ...
                        <a href="<?php echo e(url('admin/buckets')); ?>"><button type="button" class="btn btn-danger">Cancel</button></a>
                    </div>
...
<script>
  $(document).ready(function () {
      $('#portfolio_id').change(function (e) {
          ...
          $.ajax
                  ({
                      url: "<?php echo e(url('admin/getportfolioname')); ?>",
                      dataType: 'json',
  ...
  $(document).ready(function () {
      ...
      $('#portfolio_id').change(function () {
          ...
          if ($portfolioId != "" && $("#subBucket").is(":checked")) {
              $.ajax({
                  method: 'GET',
                  url: "<?php echo e(url('admin/portfolio-buckets')); ?>" + '/' + $portfolioId,
