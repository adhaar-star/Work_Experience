<?php if (isset($projectphase) && $projectphase->id) { ?>
  <?php $__env->startSection('title','Project | Edit Phase'); ?>
<?php } else { ?>
  <?php $__env->startSection('title','Project | Create Phase'); ?>
<?php } ?>

<?php $__env->startSection('body'); ?>
<?php echo Html::script('/js/jquery.validate.min.js'); ?>

<!--<?php echo Html::script('/js/phase_validation.js'); ?>-->
  ...
  <div class="panel-body">
    <div class="margin-bottom-50">
      ...
      <ul class="list-unstyled breadcrumb breadcrumb-custom">
        ...
        <li>
          <a href="<?php echo e(url('admin/projectphase')); ?>">Project Phase dashboard</a>
        </li>
        <li>
          <span>
            <?php if(isset($projectphase) && $projectphase->id): ?>
          ...
          <div class="margin-bottom-50">
            ...
            <div class="card">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                        <div class="form-input-icon">
                          ...
                          <?php if (isset($projectphase)) { ?>
                            <?php echo Form::select('phase_type',$phasetype, old('phase_type', $projectphase->phase_type), array('class'=>'select2')); ?>

                          <?php } else { ?>
                            <?php echo Form::select('phase_type',$phasetype, old('phase_type'), array('class'=>'select2')); ?>	
                          <?php } ?>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                        <div class="form-input-icon">
                          ...
                          <?php if (isset($projectphase)) { ?>
                            <?php echo Form::select('project_id',$project_id, old('project_id', $projectphase->project_id), array('class'=>'select2','id'=>'project_id')); ?>

                          <?php } else { ?>
                            <?php echo Form::select('project_id',$project_id, old('project_id'), array('class'=>'select2','id'=>'project_id')); ?>	
                          <?php } ?>
                    ...
                    if (isset($projectphase->quality_approval) && (!empty($projectphase->quality_approval))) {
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-7">
                          <div class="form-input-icon">
                            <?php if (isset($projectphase)) { ?>
                              <?php echo Form::select('persion_responsible',$personResponsible, old('person_responsible', $projectphase->person_responsible), array('class'=>'select2')); ?>

                            <?php } else { ?>
                              <?php echo Form::select('persion_responsible',$personResponsible, old('person_responsible'), array('class'=>'select2')); ?>	
                            <?php } ?>
              ...
              <div class="card-footer card-footer-box text-right">
                ...
                <a href="<?php echo e(url('admin/projectphase')); ?>"><button type="button" class="btn btn-danger">Cancel</button></a>
              </div>
            </div>
...
<script>
  $(function () {
    $('#project_id').change(function (e) {
      ...
      $.ajax
              ({
                url: "<?php echo e(url('admin/projectphase/getprojectname')); ?>/" + data,
                type: 'GET',
                dataType: 'json',
