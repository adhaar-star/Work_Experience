...
<html lang="<?php echo e(config('app.locale')); ?>">
    <head>
        ...
        <link href="<?php echo e(asset('font-awesome-4.7.0/css/font-awesome.min.css')); ?>" rel="stylesheet" type="text/css"/>
        <link href="<?php echo e(asset('materialize/css/materialize.min.css')); ?>" rel="stylesheet" type="text/css"/>
...
gtag('config', '<?php echo e(env("GOOGLE_ANALYTICS_APP_KEY")); ?>');
                ...
                <div class="right nav-container">
                    ...
                    <nav class="z-depth-0">
                        <ul>
                            ...
                            <li>
                                <a class="btn login-btn waves-effect" href="<?php echo e(url('register')); ?>">Register</a>
                            </li>
                        </ul>
                    </nav>
                </div>
            ...
            <div class="modal-content">
                <div class="row">
                    ...
                    <div id="login" class="col s12">
                        <form id="login-form" method="post" action="<?php echo e(url('api/v1/checklogin')); ?>">
                            <div class="row">
                    ...
                    <div id="register" class="col s12" style="display:none;">
                        <form id="register-form" method="post" action="<?php echo e(url('api/v1/store')); ?>">
    ...
    <!-- <script type="text/javascript" src="<?php echo e(asset('jarvis/widget')); ?>"></script> -->
    <script src="<?php echo e(asset('new_js/frontweb.js')); ?>" type="text/javascript"></script>
</body>
</html>
