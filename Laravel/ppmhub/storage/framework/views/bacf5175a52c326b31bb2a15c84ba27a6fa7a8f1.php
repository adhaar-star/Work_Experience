<?php $__env->startSection('title','Project | Dashboard'); ?>
<?php $__env->startSection('body'); ?>
<script type="text/javascript" src="https://canvasjs.com/assets/script/canvasjs.min.js"></script>
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
<?php echo Html::script('/js/project_dashboard.js'); ?>
              ...
              <div class="cart_title">
                <ul>
                  ...
                  <li class="projectx" style="padding:2px 50px;">
                    <?php echo e(Form::select('project', $projects, null, ['class' => 'project', 'id' => 'project', 'placeholder' => 'Select Project'])); ?>

                  </li>
                  <li class="statusdate" style="padding:2px 50px;">Status Date</li>
                  <li class="jul" style="padding:2px 55px;"><?php echo e(date("d-M-Y")); ?></li>
...
<?php echo $__env->make('layout.adminnewlayout', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>