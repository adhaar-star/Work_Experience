    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col s12 m6">
                <div class="feature">
                    <span class="feature-icon"><img src="<?php echo e(asset('new_images/frontweb/task-management-icon.svg')); ?>" /></span>
            ...
            <div class="col s12 m6">
                <div class="feature">
                    <span class="feature-icon"><img src="<?php echo e(asset('new_images/frontweb/time-tarcking-icon.svg')); ?>" /></span>
                    <div class="feature-details">
                        <h6>Time sheets</h6>
        ...
        <div class="row">
            <div class="col s12 m6">
                <div class="feature">
                    <span class="feature-icon"><img src="<?php echo e(asset('new_images/frontweb/gantt-charts-icon.svg')); ?>" /></span>
                    <div class="feature-details">
                        <h6>Gantt charts</h6>
            ...
            <div class="col s12 m6">
                <div class="feature">
                    <span class="feature-icon"><img src="<?php echo e(asset('new_images/frontweb/discussion-icon.svg')); ?>" /></span>
                    <div class="feature-details">
        ...
        <div class="row">
            <div class="col s12 m6">
                <div class="feature">
                    <span class="feature-icon"><img src="<?php echo e(asset('new_images/frontweb/report-icon.svg')); ?>" /></span>
                    <div class="feature-details">
                        <h6>Reports</h6>
            ...
            <div class="col s12 m6">
                <div class="feature">
                    <span class="feature-icon"><img src="<?php echo e(asset('new_images/frontweb/file-sharing-icon.svg')); ?>" /></span>
                    <div class="feature-details">
                        <h6>File sharing</h6>
        ...
        <div class="row">
            <div class="col s12 m6">
                <div class="feature">
                    <span class="feature-icon"><img src="<?php echo e(asset('new_images/frontweb/notes-icon.svg')); ?>" /></span>
                    <div class="feature-details">
                        <h6>Notes</h6>
            ...
            <div class="col s12 m6">
                <div class="feature">
                    <span class="feature-icon"><img src="<?php echo e(asset('new_images/frontweb/interation-icon.svg')); ?>" /></span>
                    <div class="feature-details">
                        <h6>Integrations</h6>
        ...
        <div class="row">
            <div class="col s12 m6">
                <div class="feature">
                    <span class="feature-icon"><img src="<?php echo e(asset('new_images/frontweb/chat-icon.svg')); ?>" /></span>
                    <div class="feature-details">
                        <h6>Chatbot</h6>
...
<section class="testimonials blue center-align">
    <div class="container">
        <div class="testimonial left-align">
            <img src="<?php echo e(asset('new_images/frontweb/testimonial-icon.png')); ?>" class="testimonial-icon">
            ...
            <div>
                <img src="<?php echo e(asset('new_images/frontweb/testimonial-face.jpg')); ?>" class="testimonial-client">
...
<?php echo $__env->make('new_layout.frontweb', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>