...
class CreateProgressCalculationPhyTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('progress_calculation_physical', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('progress_calculation_physical');
    }
