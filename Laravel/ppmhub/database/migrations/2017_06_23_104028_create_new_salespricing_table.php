...
class CreateNewSalespricingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sales_pricing', function (Blueprint $table) {
            ...
            $table->string('g_l_account_base')->nullable();
            $table->string('g_l_account_tax')->nullable();
            $table->string('g_l_account_freight')->nullable();
            $table->string('g_l_account_down')->nullable();
