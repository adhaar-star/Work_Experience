...
class CreateSalesQuotationItems extends Migration
{
    public function up()
    {
        Schema::create('sales_quotation_items', function (Blueprint $table) {

            $table->increments('sales_quotation_item_id');
            $table->integer('company_id');
            $table->integer('sales_quotation_id');
            $table->integer('sales_quotation_item_no');
