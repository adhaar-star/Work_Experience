            ...
            <main role="main" class="content marketing content-newHeader content-newFooter">
				...
				<section class="search-section">
					<div class="summary-banner-container">
						...
						$pagination = new Pagination(BASE_URL.'user-meal-detail-list.php', $db->user_food_count($detail_id), 'All food pages');

					$response = $db->user_meal_detail_list($pagination->get_limit(), $pagination->get_start(), $detail_id);
