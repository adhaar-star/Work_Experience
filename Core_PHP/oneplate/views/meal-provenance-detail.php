	...
	function change()
{
  ...
  return query_string;
	...
	var request = $.ajax({
  url: "meal-provenance-detail-expired.php",
  type: "GET",
  data: {id : expiredid},
  dataType: "html"
});
...
$categoryid=$_GET['id'];
                ...
                $active_listings = $db->get_provenance_location_active_listings($pagination->get_limit(), $pagination->get_start(),$categoryid);
//print_r($active_listings);die;
