					...
					<div class="summary-banner-container">
						...
						<div class="dashboard_right">
							...
							<div class="dashboard_right_header meal-listing-outer">
									<a href="meal-expired.php" class="button_active" type="button">Expired List</a>
									<h3><a href="my-meal.php">My Meals</a></h3>
									<div class="meal-listing">
										<div class="dropdown">
										  <button class="dropbtn">By Category</button>
										  <div class="dropdown-content">
											<a href="my-meal.php?q=1">Breakfast</a>
											<a href="my-meal.php?q=2">Lunch</a>
											<a href="my-meal.php?q=3">Dinner</a>
										  </div>
										</div>
									</div>
								...
								<div class="dashboard_right_listing" style="margin:20px 0 0">
									...
									<?php
										if(isset($_GET['q'])){
										$cat_id = $_GET['q'];
					$active_listings = $db->get_category_active_listings($pagination->get_limit(), $pagination->get_start(), $cat_id);
										}	
										else{	
