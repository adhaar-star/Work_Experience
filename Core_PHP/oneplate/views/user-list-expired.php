        ...
        <table class="table table-bordered table-striped">
            <thead>
                <tr>
                    ...
                    <th title="Category of meal" style="width:15%"><span class="glyphicon glyphicon-list"></span>Address</th>
                   ...
                   // $calc_at = $active_listings['calc_at'];
                    ...
                    foreach ($active_listings as $record) {
                       ...
                       // echo '<td>' . substr($record['description'], 0, 100) . '...</td>';
                        ...
                        echo '<td><button type="button" class="btn btn-xs btn-primary center-block"><span class="glyphicon glyphicon-fullscreen" data-name="',$record['first_name']." ".$record['last_name'],'" data-location="',$record['address'],'"
      ...
      <div class="modal-body">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <label for="email" style="font-weight: bold;">Address <strong class="text-danger"></strong></label>
