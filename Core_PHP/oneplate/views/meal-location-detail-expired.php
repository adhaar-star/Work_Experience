        ...
        <table class="table table-bordered table-striped">
            <thead>
                <tr>
                    ...
                    <th title="Time left to expire for this meal" style="width:15%"><span class="glyphicon glyphicon-time"></span> Time Since Expired</th>
            ...
            <tbody>
                <?php
$categoryid=$_GET['id'];
                $active_listings = $db->get_location_expired_listings($pagination->get_limit(), $pagination->get_start(),$categoryid);
