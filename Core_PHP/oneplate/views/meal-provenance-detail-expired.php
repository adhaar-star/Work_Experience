	...
	function change()
{
  ...
  return query_string;
	...
	var activeid=QueryString.id;
	
	
	var request = $.ajax({
  url: "meal-provenance-detail.php",
  type: "GET",
  data: {id : activeid},
  dataType: "html"
});
...
request.fail(function(jqXHR, textStatus) {
  alert( "Request failed: " + textStatus );
			...
			<button class='btn btn-success pushme' id="myButton1" style="float: right;" onclick="change()" >Active List</button>
<div class="row">
    <h2>All Expired Listings</h2>
        ...
        <table class="table table-bordered table-striped">
            <thead>
                <tr>
                    ...
                    <th title="Time left to expire for this meal" style="width:15%"><span class="glyphicon glyphicon-time"></span> Time since expiry</th>
            ...
            <tbody>
                <?php
$categoryid=$_GET['id'];
                $active_listings = $db->get_provenance_location_expired_listings($pagination->get_limit(), $pagination->get_start(),$categoryid);


                if (!empty($active_listings) && $active_listings[0]!="") {
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    <label for="address2" style="font-weight: bold;">Time since expiry</label>
