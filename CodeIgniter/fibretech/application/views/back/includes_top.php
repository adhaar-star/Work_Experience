...
<head>
	...
	<link href="<?php echo base_url(); ?>template/back/css/demo/style-demo.min.css" rel="stylesheet">
	...
	<link rel="shortcut icon" href="<?php echo base_url(); ?>template/back/img/favicon.png">
	<script>
	<?php
