<div>
    <?php
        if($this->crud_model->is_added_by('product',$product,$this->session->userdata('vendor_id'))){
		echo form_open(base_url() . 'index.php/vendor/product/add_discount_set/', array(
	...
	?>
        <div class="panel-body">
            ...
            <div class="form-group btm_border">
                ...
                <span class="btn unit_set">/<?php echo $this->crud_model->get_type_name_by_id('product',$product,'unit'); ?></span>
            </div>
