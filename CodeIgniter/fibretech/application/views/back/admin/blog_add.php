        ...
        ?>
            ...
            <div class="panel-footer">
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right" onclick="form_submit('blog_add','<?php echo translate('blog_has_been_uploaded!'); ?>');proceed('to_add');" ><?php echo translate('upload');?></span>
                    </div>
