...
//    var del_url = '<?php echo base_url() ?>skills/deleteAllSubCategory';
    ...
    var tag_url = '<?php echo base_url() . 'index.php/skills/getsubsubcategories/' . $query_category->skill_id . '/' . $this->uri->segment(4) . $suffixUrl; ?>';
    var sort_url = '<?php echo base_url() ?>index.php/skills/sortDataSubSubcategory/<?php echo $query_category->skill_id; ?>/<?php echo $this->uri->segment(4) . $suffixUrl; ?>';
</script>
    ...
    <div class='col-xs-12'>
                ...
                <div class='page-header'>
                    ...
                    <div class='pull-right'>
                        <ul class='breadcrumb'>
                            ...
                            <li class='active'><?php echo $query_parent_skill->skill_description_en ?></li>
                            <li class='separator'>
                                <i class='icon-angle-right'></i>
                            </li>
        ...
        <div class='row'>
            <div class='col-md-6 col-xs-12'>
                <input class="btn btn-primary" onclick="window.location = '<?php echo base_url() . 'index.php/skills/addSubSubCategory/' . $query_category->skill_id ?>'"  type="button" value="Add New Sub-subcategory" style="margin-bottom:5px">
            ...
            <div class="col-md-5 col-md-5 pull-right tabmt10">
                <div class="row">
                    <form action="<?php echo base_url() . 'index.php/skills/getsubsubcategories/' . $query_category->skill_id ?>" method="get">
...
//                                            $s = 1;
                                            foreach ($skills as $row) {
                                                ...
                                                echo "<td>" . $sr . "</td>";
                                                echo "<td>" . $row->skill_description_en . "</td>";
                                                echo "<td>" . $row->skill_description_ar . "</td>";
                                                echo "<td>" . $row->skill_description_zh . "</td>";
                                                echo "<td>" . $row->skill_description_es . "</td>";
												 echo "<td>" . $row->skill_description_fr . "</td>";
//                                                echo "<td>" . $query_category->skill_description . "</td>";
//                                                echo "<td>" . $query_parent_name->skill_description . "</td>";
//                                                echo "<td>" . $query_parent_skill->skill_description . "</td>";
                                                echo "<td><center>";
                                                echo "<a href='" . base_url() . "index.php/skills/editSubSubCategory/" . $query_category->skill_id . "/" . $row->skill_id . "' class = 'btn btn-success  btn-xs' title='Edit Subcategory'><i class='icon-edit'></i></a> ";
                                                ...
                                                echo "<a href='" . base_url() . "index.php/skills/delete/" . $row->skill_id . $suffixUrl . "' class = 'btn btn-danger btn-xs' title='Delete Sub-subcategory' class='del' onclick='return deletePopup(this)'><i class='icon-trash'></i></a>";
                                                echo "</center></td>";
                                                echo "</tr>";
                                                $sr++;
                                            }
