...
if ($skills) {
    foreach ($skills as $row) {
        ...
        $table.="<td>" . $sr . "</td>";
        $table.="<td><a href='" . base_url() . "index.php/skills/getcategories/" . $row->skill_id . "'  data-id='" . $row->skill_id . "'>". $row->skill_description_en . "</a></td>";
        $table.="<td><a href='" . base_url() . "index.php/skills/getcategories/" . $row->skill_id . "'  data-id='" . $row->skill_id . "'>". $row->skill_description_en . "</a></td>";
        $table.="<td><a href='" . base_url() . "index.php/skills/getcategories/" . $row->skill_id . "'  data-id='" . $row->skill_id . "'>". $row->skill_description_zh . "</a></td>";
        $table.="<td><a href='" . base_url() . "index.php/skills/getcategories/" . $row->skill_id . "'  data-id='" . $row->skill_id . "'>". $row->skill_description_es . "</a></td>";
        $table.="<td><center>";
