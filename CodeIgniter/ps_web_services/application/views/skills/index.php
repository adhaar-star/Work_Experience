...
<script>
    ...
    var tag_url = '<?php echo base_url() .'index.php/skills/index/' . $this->uri->segment(3) . $suffixUrl; ?>'; 
    var sort_url = '<?php echo base_url() ?>index.php/skills/sortData/<?php echo $this->uri->segment(3) . $suffixUrl; ?>';
</script>
    ...
    <div class='col-xs-12'>
        ...
        <div class='row'>
            <div class='col-md-6 col-xs-12'>
                <input class="btn btn-primary" onclick="window.location = '<?php echo base_url() ?>index.php/skills/add'"  type="button" value="Add New Skill" style="margin-bottom:5px">
            ...
            <div class="col-md-5 col-md-5 pull-right tabmt10">
                <div class="row">
                    <form action="<?php echo base_url() . 'index.php/skills' ?>" method="get">
...
//                                            $s = 1;
                                            foreach ($skills as $row) {
                                                ...
                                                echo "<td>" . $sr . "</td>";
                                                echo "<td><a href='" . base_url() . "index.php/skills/getcategories/" . $row->skill_id . "'  data-id='" . $row->skill_id . "'>". $row->skill_description_en . "</a></td>";
                                                echo "<td><a href='" . base_url() . "index.php/skills/getcategories/" . $row->skill_id . "'  data-id='" . $row->skill_id . "'>". $row->skill_description_ar . "</a></td>";
                                                echo "<td><a href='" . base_url() . "index.php/skills/getcategories/" . $row->skill_id . "'  data-id='" . $row->skill_id . "'>". $row->skill_description_zh . "</a></td>";
                                                echo "<td><a href='" . base_url() . "index.php/skills/getcategories/" . $row->skill_id . "'  data-id='" . $row->skill_id . "'>". $row->skill_description_es . "</a></td>";
												  echo "<td><a href='" . base_url() . "index.php/skills/getcategories/" . $row->skill_id . "'  data-id='" . $row->skill_id . "'>". $row->skill_description_fr . "</a></td>";
                                                echo "<td><center>";
