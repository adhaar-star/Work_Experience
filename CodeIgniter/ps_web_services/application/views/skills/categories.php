...
?>
<script>
//    var del_url = '<?php // echo base_url() .'skills/deleteAllCategory'   ?>';
    var del_url = '<?php echo base_url() . 'index.php/skills/deleteAll' ?>';
    var tag_url = '<?php echo base_url() . 'index.php/skills/getcategories/' . $query_parent->skill_id . '/' . $this->uri->segment(4) . $suffixUrl; ?>';
    var sort_url = '<?php echo base_url() . 'index.php/skills/sortDataCategory/' . $query_parent->skill_id . '/' . $this->uri->segment(4) . $suffixUrl; ?>';
</script>
    ...
    <div class='col-xs-12'>
            ...
            <div class='col-sm-12'>
                <div class='page-header'>
                    <h1 class='pull-left'>
                        ...
                        <span>All Skills Of <?php echo $query_parent->skill_description_en; ?></span>
                    </h1>
                    <div class='pull-right'>
                        <ul class='breadcrumb'>
                            ...
                            <li class='active'><?php echo $query_parent->skill_description_en; ?></li>
        ...
        <div class='row'>
            <div class='col-md-6 col-xs-12'>
                <input class="btn btn-primary" onclick="window.location = '<?php echo base_url() . 'index.php/skills/addCategory/' . $query_parent->skill_id ?>'"  type="button" value="Add New Category" style="margin-bottom:5px">
            ...
            <div class="col-md-5 col-md-5 pull-right tabmt10">
                <div class="row">
                    <form action="<?php echo base_url() . 'index.php/skills/getcategories/' . $query_parent->skill_id ?>" method="get">
...
//                                            $s = 1;
                                            foreach ($skills as $row) {
                                                ...
                                                echo "<td>" . $sr . "</td>";
                                                echo "<td><a href='" . base_url() . "index.php/skills/getsubcategories/" . $row->skill_id . "'  data-id='" . $row->skill_id . "'>" . $row->skill_description_en . "</a></td>";
                                                echo "<td><a href='" . base_url() . "index.php/skills/getsubcategories/" . $row->skill_id . "'  data-id='" . $row->skill_id . "'>" . $row->skill_description_ar . "</a></td>";
                                                echo "<td><a href='" . base_url() . "index.php/skills/getsubcategories/" . $row->skill_id . "'  data-id='" . $row->skill_id . "'>" . $row->skill_description_zh . "</a></td>";
                                                echo "<td><a href='" . base_url() . "index.php/skills/getsubcategories/" . $row->skill_id . "'  data-id='" . $row->skill_id . "'>" . $row->skill_description_es . "</a></td>";
												
  echo "<td><a href='" . base_url() . "index.php/skills/getsubcategories/" . $row->skill_id . "'  data-id='" . $row->skill_id . "'>" . $row->skill_description_fr . "</a></td>";												
//                                                echo "<td>" . $query_parent->skill_description . "</td>";

                                                echo "<td><center>";
                                                echo "<a href='" . base_url() . "index.php/skills/editCategory/" . $query_parent->skill_id . "/" . $row->skill_id . "' class = 'btn btn-success  btn-xs' title='Edit Category'><i class='icon-edit'></i></a>  ";
                                                ...
                                                echo "<a href='" . base_url() . "index.php/skills/delete/" . $row->skill_id . $suffixUrl . "' class = 'btn btn-danger btn-xs' title='Delete Category' class='del' onclick='return deletePopup(this)'><i class='icon-trash'></i></a>";
                                                echo "</center></td>";
                                                echo "</tr>";
                                                $sr++;
                                            }
...
<script>
    ...
    function deletePopup(obj) {
        jconfirm("Do you really want to delete this Category?", function (r) {
            console.log(r);
            if (r) {
                window.location = $(obj).attr('href');
            }
