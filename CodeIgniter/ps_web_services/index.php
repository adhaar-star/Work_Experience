...
//                                            $s = 1;
		...
		$description = (!empty(htmlentities(base64_decode($row->description)))) ? htmlentities(base64_decode($row->description)) : htmlentities($row->description);
$action = (!empty(htmlentities(base64_decode($row->action)))) ? htmlentities(base64_decode($row->action)) : htmlentities($row->action);												
                                                echo "<tr>";
                                                echo "<td>" . $sr . "</td>";
