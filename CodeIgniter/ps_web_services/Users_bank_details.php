...
class Users_bank_details extends CI_Controller {
    ...
    public function index() {
        ...
        $query = "select b.*,u.user_name from " . $this->table . " b Left join " . TBL_USERS . " u on u.user_id = b.user_id";

		       // $query = "select * from " . TBL_USERS  . " u Left join " . $this->table  . " b on u.user_id = b.user_id";
 //print_r($query);die;
        if ($this->input->get('keyword')) {
    ...
    public function view($id = NULL) {
        if ($id != '') {
            ...
            $query = "select b.*,u.user_name from " . $this->table . " b Left join " . TBL_USERS . " u on u.user_id = b.user_id Where b.bank_id = '$id'";
