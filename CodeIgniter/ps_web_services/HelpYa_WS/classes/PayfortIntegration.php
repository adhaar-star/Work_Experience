    ...
    public function calculateFortSignature($shaRequestPharse, $securityType) {
     ...
     //android
       /* $requestParams = array(
            ...
            'merchant_identifier'   => 'XsdFmAiQ',
            'access_code'           => 'xbUr0NHca42ghvvi48x2',
            'device_id'     => '00000000-6827-7895-ffff-ffff99d603a9',
            'language'              => 'en'
        );*/
...
/*$requestParams = array(
            ...
            'merchant_identifier'   => 'XsdFmAiQ',
            'access_code'           => 'xbUr0NHca42ghvvi48x2',
            'merchant_reference'     => 'rar1212',
            'language'              => 'en',
            'return_url' => 'http://clientapp.narolainfotech.com/pg/ALN/returnPageSample.php'
        );*/
       ...
       $requestParams = array(
            ...
            'merchant_identifier'   => 'XsdFmAiQ',
            'access_code'           => 'xbUr0NHca42ghvvi48x2',
            'customer_email'           => 'an.narola@gmail.com',
            'currency'           => 'SAR',
            'amount'           => '70',
            'language'              => 'en',
            'token_name'              => 'Op5xlE6mY',
            'merchant_reference'     => 'rar12123',
            'customer_name'              => 'Alisha Narola',
            'return_url' => 'http://clientapp.narolainfotech.com/pg/ALN/returnPageSample.php'
        );
