...
//                                    exit();
    ...
    public function update(array $data, $returnData = false, $debug = false ) {
        ...
        try {
            ...
            //var_dump($stmt, array_merge($setValues, $this->values));
    ...
    public function all($filter = true, $debug = false) {
        ...
        try {
            ...
            //var_dump($stmt, $this->values);
      //    if($this->tableName=="master_study_field"){
            //echo "s";die;
           // var_dump($stmt, $this->values);die;
       // }
            if($debug === true) var_dump($stmt, $this->values);
    ...
    public function orWhereBetween(array $where = array(), $custom = false) {
        
        $this->_buildWhere('OR', 'AND', $where, false, true);
        
        return $this;
    }

      public function andOrWhereBetween(array $where = array(), $custom = false) {
        
        $this->_buildWhere('AND', 'OR', $where, false, true);
...
//        $this->tableName = $this->tableName . ' , ' . $table;
    ...
    public function setPDOConnection($param) {
        $this->pdoConnection = $param;
    }
}