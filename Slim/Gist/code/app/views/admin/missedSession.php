...
<div class="side-body">
    ...
    <table id="example" class="table table-striped table-bordered complete-session missedSessionTable">
        <thead>
            <tr>
                <th>Session Id</th>
                <th>Title</th>
...
<script>
    ...
    $('.missedSessionTable').DataTable({
        ...
        "language": {
            "emptyTable": "No missed sessions."
        },
        "sAjaxSource": Data.base_url + "admin/missedSessionDetail/",
    });

    // Tooltip in bootstrap for datatables
    $('.missedSessionTable').on('draw.dt', function () {
